    ...
    <div class="nk-content-inner">
        <div class="nk-content-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <a href="{{ route('talent.products.create') }}" class="btn btn-primary btn-md">
                        Add Product
                    </a>
                </div>
            </div>
            <div class="card card-bordered card-preview">
                <div class="card-inner table-responsive">
                    <table class="table table-hover datatable-init nowrap  align-middle">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Image</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $key + 1 }}</td>
                                <td>
                                    <img src="{{ asset('storage/' . $product->image) }}" alt="Product" width="50" height="50" class="rounded-circle me-2">
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <small class="d-block text-muted">{{ $product->seller->address ?? '' }}</small>
                                </td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="actionsDropdown{{ $product->id }}">
                                            <li>
                                                <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#viewModal{{ $product->id }}">Quick View</a>
                                            </li>
                                            <li>
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content border-0 rounded-4 shadow">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a type="button" href="{{ route('talent.products.view', $product->id) }}" class="btn btn-primary">Full view product</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal fade" id="statusModal{{ $product->id }}" tabindex="-1" aria-labelledby="statusModalLabel{{ $product->id }}" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-md">
                                    <div class="modal-content border-0 rounded-4 shadow">
                                        ...
                                        <form action="{{ route('talent.products.updateStatus', $product->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <div class="modal-body">
                                                <div class="mb-3">
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content border-0 rounded-4 shadow">
                                        ...
                                        <div class="modal-body text-center">
                                            ...
                                            <form action="{{ route('talent.products.destroy', $product->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
