...
<div class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('talent.jobs.index') }}" class="btn btn-outline-primary rounded-pill">
    ...
    <div class="card border-0 shadow-lg rounded-4">
        <div class="card-body p-4">
            ...
            <div class="mt-5">
                <a href="{{ route('talent.jobs.applications', $job->id) }}" class="btn btn-outline-success rounded-pill px-4 py-2">
