                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span class="files-icon flex-shrink-0"><i class="ti ti-photo"></i></span>
                                            <div>
                        ...
                        <table class="table">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <span class="badge badge-success-transparent text-success"><i class="ti ti-point-filled me-1"></i>Paid</span>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <span class="badge badge-success-transparent"><i class="ti ti-point-filled me-1"></i>Paid</span>
                                    </td>
                                    <td class="text-end amount-info w-25">
                                        <h6 class="mb-0">+$500</h6>
                                        <a href="javascript:void(0);" class="btn btn-primary btn-md " data-bs-toggle="modal" data-bs-target="#transaction_details">View</a>
