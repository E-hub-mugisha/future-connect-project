    ...
    <div class="nk-sidebar-element nk-sidebar-head">
        ...
        <div class="nk-sidebar-brand">
            <a href="{{ route('user.home') }}" class="logo-link nk-sidebar-logo">
                <img class="logo-light logo-img" src="{{ asset('assets/img/WORDMARK.png') }}" srcset="{{ asset('assets/img/WORDMARK.png') }}" alt="logo">
                <img class="logo-dark logo-img" src="{{ asset('assets/img/WORDMARK.png') }}" srcset="{{ asset('assets/img/WORDMARK.png') }}" alt="logo-dark">
            </a>
        </div>
    </div>
            ...
            <div class="nk-sidebar-menu" data-simplebar>
                <ul class="nk-menu">
                    ...
                    <li class="nk-menu-item">
                        ...
                        <li class="nk-menu-item">
                            <a href="/admin/talents" class="nk-menu-link {{ isActiveRoute('admin.talents.*', 'admin/talents*') }}">
                                <i class="ti ti-user-bolt me-2"></i><span>Talents</span>
                            </a>
                        </li>
                        <li class="nk-menu-item">
                            <a href="/admin/users" class="nk-menu-link {{ isActiveRoute('admin.users.*', 'admin/users*') }}">
                                <i class="ti ti-wallet me-2"></i><span>Users</span>
                            </a>
                        </li>
                        <li class="nk-menu-item">
                            <a href="/admin/categories" class="nk-menu-link {{ isActiveRoute('admin.categories.*', 'admin/categories*') }}">
