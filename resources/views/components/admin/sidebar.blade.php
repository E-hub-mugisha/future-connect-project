...
.fc-logo-text {
    font-family: 'Syne','DM Sans',sans-serif;
    font-weight: 600; font-size: 14px; color: var(--fc-white);
    line-height: 1.2; letter-spacing: 0.01em;
}
.fc-logo-text small {
    display: block; font-size: 10px; font-weight: 400;
    color: var(--fc-w30); letter-spacing: 0.06em; margin-top: 1px;
}

/* ── Body scroll ──────────────────────────────────────── */
.nk-sidebar-body { background: var(--fc-bg-2) !important; }
.nk-sidebar-content { background: var(--fc-bg-2) !important; }
.nk-sidebar-menu { padding: 8px 0 80px !important; }

/* ── Section headings ─────────────────────────────────── */
.fc-section {
    padding: 18px 16px 6px;
    font-size: 9.5px; font-weight: 500; letter-spacing: 0.10em;
    text-transform: uppercase; color: var(--fc-w30);
}

/* ── Nav items ────────────────────────────────────────── */
.nk-menu { list-style: none; padding: 0; margin: 0; }
.nk-menu-item { margin: 1px 8px; }
...
.nk-menu-link.active .fc-nav-icon { color: var(--fc-green) !important; }
...
.fc-nav-icon svg { width: 17px; height: 17px; }
.nk-menu-link:hover .fc-nav-icon { color: var(--fc-white); }
...
.fc-pill-green { background: var(--fc-green);  color: #fff; }
.fc-pill-red   { background: var(--fc-red);    color: #fff; }
.fc-pill-amber { background: var(--fc-amber);  color: #fff; }
...
.fc-admin-info { flex: 1; min-width: 0; }
.fc-admin-name {
    font-size: 12.5px; font-weight: 500; color: var(--fc-white);
    white-space: nowrap; overflow: hidden; text-overflow: ellipsis;
}
.fc-admin-role { font-size: 10.5px; color: var(--fc-w60); margin-top: 1px; }
.fc-logout-btn {
    background: none; border: none; cursor: pointer;
    color: var(--fc-w30); display: flex; padding: 0;
    transition: color 0.15s;
}
.fc-logout-btn:hover { color: var(--fc-red); }

/* ── Scrollbar ────────────────────────────────────────── */
.nk-sidebar-menu::-webkit-scrollbar { width: 4px; }
.nk-sidebar-menu::-webkit-scrollbar-track { background: transparent; }
.nk-sidebar-menu::-webkit-scrollbar-thumb { background: var(--fc-w10); border-radius: 4px; }

/* ── Mobile toggle ────────────────────────────────────── */
.nk-nav-toggle { color: var(--fc-w60) !important; }
.nk-nav-toggle:hover { color: var(--fc-white) !important; }
</style>
                    ...
                    @if($role === 'admin')
                        ...
                        <li class="nk-menu-item">
                            <a href="/admin/jobs" class="nk-menu-link {{ $isActive('admin.jobs.*') }}">
                                <span class="fc-nav-icon">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/></svg>
                                </span>
                                <span>Jobs</span>
                            </a>
                        </li>
                        ...
                        <li class="nk-menu-item">
                            <a href="/admin/connections" class="nk-menu-link {{ $isActive('admin.connections.*') }}">
                                <span class="fc-nav-icon">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><circle cx="12" cy="12" r="3"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14M4.93 4.93a10 10 0 0 0 0 14.14"/></svg>
                                </span>
