...
<style>
    ...
    .fc-top-nav__inner a:hover {
        color: #48d597;
    }

    .fc-top-nav__inner a:hover::after {
        width: 100%;
    }
   ...
   (set by the header's theme switch)
══════════════════════════════════════ */
    [data-h-theme="light"] .fc-footer {
        background: #f6faf8;
        color: #4a615d;
    }

    [data-h-theme="light"] .fc-footer a {
        color: #4a615d;
    }

    [data-h-theme="light"] .fc-footer a:hover {
        color: #00a667;
    }

    [data-h-theme="light"] .fc-top-nav {
        border-bottom-color: rgba(0, 100, 60, 0.1);
    }

    [data-h-theme="light"] .fc-top-nav__inner a {
        color: #3d5a52;
    }

    [data-h-theme="light"] .fc-top-nav__inner a:hover {
        color: #00a667;
    }

    [data-h-theme="light"] .fc-top-nav__inner a::after {
        background: #00a667;
    }

    [data-h-theme="light"] .fc-col-title {
        color: #00a667;
        border-bottom-color: rgba(0, 166, 103, 0.28);
    }

    [data-h-theme="light"] .fc-link-list a {
        color: #4a615d;
    }

    [data-h-theme="light"] .fc-link-list .arrow {
        color: #00a667;
    }

    [data-h-theme="light"] .fc-contact-icon {
        background: rgba(0, 166, 103, 0.08);
        border-color: rgba(0, 166, 103, 0.25);
    }

    [data-h-theme="light"] .fc-contact-icon svg {
        stroke: #00a667;
    }

    [data-h-theme="light"] .fc-contact-label {
        color: #00a667;
    }

    [data-h-theme="light"] .fc-contact-value,
    [data-h-theme="light"] .fc-contact-value a {
        color: #4a615d;
    }

    [data-h-theme="light"] .fc-contact-value a:hover {
        color: #00a667;
    }

    [data-h-theme="light"] .fc-divider {
        border-top-color: rgba(0, 60, 40, 0.08);
    }
    ...
    [data-h-theme="light"] .fc-logo-mark svg {
        fill: #fff;
    }

    [data-h-theme="light"] .fc-social a {
        border-color: rgba(0, 60, 40, 0.12);
        color: #5b7a73;
    }

    [data-h-theme="light"] .fc-social a:hover {
        background: #00a667;
        border-color: #00a667;
        color: #fff;
    }

    [data-h-theme="light"] .fc-legal a {
        color: #6f8a85;
    }

    [data-h-theme="light"] .fc-legal a:hover {
        color: #00a667;
    }

    [data-h-theme="light"] .fc-copy {
        color: #8ca39d;
    }
</style>
...
<footer class="fc-footer">
    ...
    <div class="fc-top-nav">
        <div class="fc-top-nav__inner">
            ...
            <a href="{{ route('user.talents') }}">Skills</a>
