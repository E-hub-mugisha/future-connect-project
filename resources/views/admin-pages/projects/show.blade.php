                                ...
                                <div class="list-group-item py-3 border-0 border-bottom">
                                    ...
                                    <div class="mt-3">
                                        <form action="#" method="POST" class="d-inline">
                                            @csrf
                                            <button type="button" class="btn btn-sm btn-outline-success rounded-pill">Accept</button>
                                        </form>
                                        <form action="#" method="POST" class="d-inline">
                                            @csrf
                                            <button type="button" class="btn btn-sm btn-outline-danger rounded-pill">Reject</button>
                                        </form>
                                    </div>
                                </div>
                            @endforeach
