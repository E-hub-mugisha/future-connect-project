...
<div class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('admin.jobs.show', $job->id) }}" class="btn btn-outline-primary rounded-pill">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <form action="{{ route('admin.jobs.updateApplicationStatus', $application->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('PATCH')
