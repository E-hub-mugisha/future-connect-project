            ...
            <div class="col-md-12">
                ...
                <div class="marketing-section postLists">
                    <div class="marketing-content">
                        <h2>Future connector Job portal</h2>
                ...
                <div class="filters-section">
                    <ul class="filters-wrap">
                        ...
                        <li>
                            <div class="mb-4">
                                <form method="GET" action="{{ route('user.jobs.index') }}" class="d-flex">
                                    <input type="text" name="search" class="form-control me-2" placeholder="Search by job title or skills" value="{{ request('search') }}">
