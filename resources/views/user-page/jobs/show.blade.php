...
.jd-meta__item a:hover { text-decoration: underline; }
.jd-meta__item i { font-size: 14px; }
.jd-badge {
    display: inline-flex;
    align-items: center;
    padding: 4px 12px;
...
.jd-sidebar-card:hover { border-color: rgba(255,255,255,.15); }
...
.jd-sidebar-card__header img { width: 18px; height: 18px; opacity: .7; }
...
.jd-sidebar-card__body { padding: 16px 18px; }
...
.jd-recent-item__title a:hover { color: var(--accent); }
...
.jd-modal .modal-body { padding: 24px; }
.jd-modal .form-label {
    font-size: 13px;
    font-weight: 600;
...
.jd-modal .form-control::placeholder { color: var(--muted); }
.jd-modal-submit {
    display: inline-flex;
    align-items: center;
    gap: 8px;
...
.jd-modal-submit:hover { background: #5fe8a8; }
...
.jd-subscribe-btn:hover { background: #5fe8a8; color: #0e1618; }
.jd-close-btn {
    padding: 10px 24px;
...
.jd-close-btn:hover { border-color: rgba(255,255,255,.25); color: var(--text); }
</style>
