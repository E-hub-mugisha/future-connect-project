...
<head>
  ...
  <title>Skill Registration Successful — Future Connect</title>
...
<body>
  ...
  <div class="fc-success-page">
    <div class="fc-success-card">
      ...
      <p class="fc-success-eyebrow">Application Received</p>
      <h2>Skill Registration Successful!</h2>
      <p class="fc-success-lede">
      ...
      <div class="fc-summary">
        <div class="fc-summary-row">
          ...
          <div class="fc-summary-text">
            <span class="fc-summary-label">Name</span>
            <span class="fc-summary-value">{{ $talent->name }}</span>
          </div>
        </div>
        ...
        <div class="fc-summary-row">
          ...
          <div class="fc-summary-text">
            <span class="fc-summary-label">Email</span>
            <span class="fc-summary-value">{{ $talent->email }}</span>
          </div>
        </div>
        ...
        <div class="fc-summary-row">
          ...
          <div class="fc-summary-text">
            <span class="fc-summary-label">Category</span>
            <span class="fc-summary-value">{{ $talent->category->name }}</span>
          </div>
        </div>
      </div>

      <div class="fc-success-actions">
        <a href="{{ route('user.home') }}" class="fc-btn fc-btn-primary">
          <svg viewBox="0 0 24 24"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
          Back to Home
        </a>
        <a href="{{ route('login') }}" class="fc-btn fc-btn-ghost">
          View My Profile
          <svg viewBox="0 0 24 24"><path d="M5 12h14M13 5l7 7-7 7"/></svg>
        </a>
      </div>

      <p class="fc-success-footnote">You'll receive a confirmation email within 24–48 hours.</p>
