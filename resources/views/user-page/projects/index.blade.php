...
<style>
    ...
    .fc-hero h1 span{ color:var(--fc-accent); }
    .fc-hero p.lead-text{ color:var(--fc-muted); font-size:1.05rem; max-width:520px; }
    ...
    .fc-search-card .form-control::placeholder{ color:#5f7370; }
    ...
    .fc-input-block{ margin-bottom:16px; }
    .fc-input-locaion{ position:relative; }
    .fc-input-locaion img{
        position:absolute; right:12px; top:50%; transform:translateY(-50%);
        width:16px; opacity:.7;
    }
    ...
    .fc-popular-search{ margin-top:20px; }
    ...
    .fc-popular-search ul{ list-style:none; display:flex; gap:10px; flex-wrap:wrap; padding:0; margin:0; }
    .fc-popular-search a{
    ...
    /* ---- Categories ---- */
    .fc-categories{ background:var(--fc-bg-alt); padding:60px 0; border-bottom:1px solid var(--fc-border); }
    .fc-section-header{ text-align:center; margin-bottom:40px; }
    .fc-section-header h2{
        font-weight:700; font-size:1.9rem; color:var(--fc-white); margin-bottom:8px;
    }
    .fc-section-header h2 .accent-dot{ color:var(--fc-accent); }
    .fc-section-header p{ color:var(--fc-muted); }
    ...
    .fc-cat-card h6 a:hover{ color:var(--fc-accent); }
    .fc-cat-card p{ color:var(--fc-muted); font-size:.85rem; margin:6px 0 0; }

    /* ---- Project cards ---- */
    .fc-projects{ padding:70px 0; }
    .fc-gig-card{
        background:var(--fc-card);
        border:1px solid var(--fc-border);
        border-radius:18px;
    ...
    .fc-cta h2{ font-weight:700; color:var(--fc-white); }
    .fc-cta p{ color:var(--fc-muted); max-width:420px; }
    .fc-cta img{ max-width:100%; }
</style>
