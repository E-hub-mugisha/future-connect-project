...
@section('title', 'Top Rated Skills | Future Connect')
@section('content')
...
<div class="page-header">
  <div class="container">
    <div class="page-header-eyebrow">Top rated</div>
    <h1>
      Explore <span class="accent">Top rated</span> Skilled People
    </h1>
    <p>Connect with the next wave of skilled professionals — fresh perspectives, Top rated skills.</p>
  </div>
</div>
