                ...
                <div class="postLists">
                    ...
                    <div class="service-card w-100 mb-4">
                        <div class="service-video-wrap text-center">
                            <div class="video-wrapper position-relative overflow-hidden" style="width: 100%; padding-top: 56.25%;">
            ...
            <div class="col-lg-4 theiaStickySidebar ">
                <div class="postLists">
                    <div class="service-widget member-widget ">
                        ...
                        <a href="{{ route('user.talent.details', $story->talent->id) }}" class="btn btn-outline-primary rounded-pill mb-0 w-100">Back to profile</a>
                    </div>
