...
const CategoryStory = () => {
    ...
    const fetchStoryByCategory = useCallback(async () => {
        try {
            const res = await api.get(`/story/category/${slug}`);
            ...
            <div className="new-services-section">
                <div className="container">
                    <div className="section-header-two text-center" data-aos="fade-up">
                        <h2 className="mb-2"><span className="title-bg"></span>Our {categoryName} stories<span className="title-bg2"></span></h2>
                    ...
                    <div className="row">
                        {stories.length > 0 ? (
                            ...
                            <p className="text-center mt-4">No story found for {categoryName}.</p>
                        )}
                    </div>
                </div>
            </div>
