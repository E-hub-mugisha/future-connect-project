                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="service-widget member-widget">
                            ...
                            <div class="member-info member-info-new">
                                <div class="row">
                                    <div class="col-md-4 member-list d-flex align-items-center gap mb-3">
                                    ...
                                    <div class="col-md-4 member-list d-flex align-items-center gap">
                            ...
                            <div class="mt-4">
                                ...
                                <a role="button" tabindex="0" data-bs-toggle="modal" data-bs-target="#support_talent"
                                    class="btn slide-line-btn mb-0">Connect with Talent
                                    <span class="slide-line"></span>
                                    <span class="slide-line"></span>
                                    <span class="slide-line"></span>
                                </a>
                    ...
                    <div class="col-12">
                            ...
                            <div class="listing-slider">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <a href="javascript:void(0);" class="nav-link active" data-bs-toggle="tab" data-bs-target="#about_gigs" aria-selected="true" role="tab">
                                            About Me
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);" class="nav-link" data-bs-toggle="tab" data-bs-target="#faq" aria-selected="false" role="tab" tabindex="-1">
                                            Stories
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);" class="nav-link" data-bs-toggle="tab" data-bs-target="#recent_works" aria-selected="false" role="tab" tabindex="-1">
                                            Courses
                                        </a>
                                    </li>
                                    <li>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade active show" id="about_gigs" role="tabpanel">
                                <!-- About Gigs -->
...
<div class="modal fade" id="support_talent" tabindex="-1" aria-labelledby="supportTalentLabel" aria-hidden="true">
    <div class="modal-dialog postLists">
