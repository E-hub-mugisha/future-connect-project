    ...
    <div className="new-services-section">
        <div className="container">
            <div className="section-header-two text-center" data-aos="fade-up">
                <h2 className="mb-2"><span className="title-bg"></span>Our {{ $categoryName }} Skills<span
                            ...
                            <div class="gigs-grid">
                                ...
                                <div class="gigs-content">
                                    <div class="gigs-info">
                                        ...
                                        <div class="star-rate">
                                            <span>
                                                <i class="fa-solid fa-star"></i> 4.8 (360 Reviews)
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="gigs-card-footer">
                                        <div class="d-flex align-items-center gigs-left-text">
                                            <a href="{{ url('/talent-profile/' . ($skill->talent->id ?? '')) }}"
