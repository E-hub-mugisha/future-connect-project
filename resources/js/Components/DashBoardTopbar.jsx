    ...
    return (
        <>
            <style>{`
                ...
                .t-search-input:focus { background: var(--tb-input-focus); border-color: rgba(72, 213, 151, 0.45); }
                ...
                .t-icon-btn:hover { background: var(--tb-hover); color: var(--accent); }
                ...
                .t-badge-dot.gold { background: var(--accent); }
                .t-dropdown {
                ...
                .t-dropdown-link { font-size: 11.5px; color: var(--accent); text-decoration: none; font-weight: 500; }
                ...
                .t-notif-icon { width: 36px; height: 36px; border-radius: 8px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; background: rgba(72, 213, 151, 0.12); color: var(--accent); }
                ...
                .t-notif-type { font-size: 10.5px; font-weight: 500; padding: 2px 7px; border-radius: 20px; letter-spacing: 0.03em; background: rgba(72, 213, 151, 0.12); color: var(--accent); }
                ...
                .t-profile-link.danger { color: rgba(0, 0, 0, 0.55); }
                .t-profile-link.danger:hover { background: rgba(0, 0, 0, 0.05); color: #000000; }
                ...
                .t-mobile-search-cancel { color: var(--accent); }
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                            <div style={{ position: "relative", flex: 1 }}>
                                ...
                                <input
                                    ...
                                    style={{ width: "100%", height: 40, borderRadius: 9, padding: "0 14px 0 36px", fontSize: 14, outline: "none" }}
                                />
                            </div>
                            <button
                                onClick={() => setMobileSearchOpen(false)}
                                className="t-mobile-search-cancel"
                                style={{ fontSize: 13, border: "none", background: "none", cursor: "pointer", whiteSpace: "nowrap", padding: 4 }}
                            >
                                Cancel
                            </button>
                        </div>
