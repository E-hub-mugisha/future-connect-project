...
/**
 * Future Connect — Forgot Password Page (Inertia + React)
 * Shares the fcToggleTheme / initTheme pattern and grid-based card layout
 * with Login.jsx and Register.jsx.
 */
...
export default function ForgotPassword({ status }) {
    ...
    return (
        <>
            <Head title="Forgot Password | Future Connect" />
            ...
            <div className="fp-scope">
                <div className="fp-page">
                    ...
                    <div className="fp-back-nav">
                        <Link href={route('login')} className="fp-back-btn">
                    ...
                    <div className="fp-card">
                        ...
                        <div className="fp-panel-left">
                            ...
                            <Link href={route('user.home')} className="fp-logo-lockup">
                                ...
                                <div>
                                    <p className="fp-logo-wordmark">Future Connect</p>
                                    <p className="fp-logo-tagline">Empowering Stories. Real Impact.</p>
                                </div>
                            </Link>

                            <div>
                                <div className="fp-pill">Rwanda&rsquo;s #1 skills Platform</div>
                            ...
                            <div className="fp-stats">
                                <div className="fp-stat">
                                    <div className="fp-stat-val">8K+</div>
                                    <div className="fp-stat-lbl">Skills</div>
                                </div>
                                <div className="fp-stat">
                                    <div className="fp-stat-val">4.8★</div>
                                    <div className="fp-stat-lbl">Rating</div>
                                </div>
                                <div className="fp-stat">
                                    <div className="fp-stat-val">100%</div>
                                    <div className="fp-stat-lbl">Verified</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="fp-panel-right">
                            <div className="fp-form-head">
                                <div className="fp-eyebrow">Reset password</div>
                                <h1>
                                    Forgot your
                                    <br />
                                    password?
                                </h1>
                                <p>No problem. Enter your email address and we&rsquo;ll send you a link to choose a new one.</p>
                            </div>
                            ...
                            <form onSubmit={submit}>
                                ...
                                <div className="fp-field">
                                    ...
                                    <div className="fp-input-wrap">
                                        <svg className="fp-ico" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                                ...
                                {/* Submit */}
                                <button className="fp-btn" type="submit" disabled={processing}>
                            ...
                            <div className="fp-signup-row">
                                Remember your password? <Link href={route('login')}>Log in</Link>
                            </div>
                        </div>
                    </div>
                </div>
