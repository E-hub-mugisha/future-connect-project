...
/**
 * Future Connect — Login Page (Inertia + React)
 *
 * Theme system follows the fcToggleTheme / initTheme pattern used across
 * FutureConnect (pricing page, demo request page): a `data-theme` attribute
 * on <html>, persisted to localStorage, defaulting to the user's OS preference.
 */
...
export default function Login({ status, canResetPassword }) {
    ...
    return (
        <>
            <Head title="Login | Future Connect" />

            <div className="page">
                <div className="orb orb-1" />
                <div className="orb orb-2" />

                {/* ── Top-right controls: theme toggle + back button ── */}
                ...
                <div className="card">
                    ...
                    <div className="panel-left">
                        ...
                        <Link href={route('user.home')} className="fc-logo-lockup">
                        ...
                        <div>
                            <div className="pill">Rwanda&rsquo;s #1 skills Platform</div>
                    ...
                    <div className="panel-right">
                        ...
                        <form onSubmit={submit}>
                            ...
                            <div className="row-mid">
                                ...
                                {canResetPassword && (
                                    <Link className="forgot" href={route('password.request')}>
                                        Forgot password?
                                    </Link>
                                )}
                            </div>
                        ...
                        <div className="signup-row">
                            Don&rsquo;t have an account? <Link href={route('register')}>Sign Up for free</Link>
                        </div>
                    </div>
                </div>
            </div>
