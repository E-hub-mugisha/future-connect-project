                ...
                <header className="dr-topheader" ref={topbarRef}>
                    <div className="dr-topheader-inner">
                        <Link href={r("user.home")} className="dr-th-logo">
                            ...
                            <span className="dr-th-logo-text">
                ...
                <div className="dr-page">
                    ...
                    <div className="dr-left">
                        <Link href={r("user.home")} className="dr-logo-lockup">
                            ...
                            <div>
                                <p className="dr-logo-wordmark">
                                    Future Connect
                                </p>
                                <p className="dr-logo-tagline">
                        ...
                        <div className="dr-left-body">
                            ...
                            <p>
                                ...
                                and discover how Future Connect can help you
                                find, vet, and hire the right talent fast.
                            </p>

                            <div className="dr-features">
                                <div className="dr-feature">
                                    <div className="dr-feature-icon">
                                        {/* FIXED: was a truncated/incomplete <svg x
                                            tag with no closing element — replaced
                                            with a target icon matching the stroke
                                            style used by the other feature icons. */}
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 24 24"
                                            fill="none"
                                    ...
                                    <div className="dr-feature-text">
                                        ...
                                        <span>
                                            We'll walk through the features most
                                            relevant to your team and use case.
                                        </span>
                                    </div>
                                </div>
                                <div className="dr-feature">
                                    ...
                                    <div className="dr-feature-text">
                                        ...
                                        <span>
                                            A quick, friendly session — ask
                                            anything, no obligation to buy.
                                        </span>
                                    </div>
                                </div>
                                <div className="dr-feature">
                                    ...
                                    <div className="dr-feature-text">
                                        ...
                                        <span>
                                            See live examples of verified talent
                                ...
                                <div className="dr-feature">
                                    ...
                                    <div className="dr-feature-text">
                                        ...
                                        <span>
                                            ...
                                            we'll confirm within one business
                                            day.
                                        </span>
                                    </div>
                                </div>
                    ...
                    <div className="dr-right">
                        <div className="dr-topbar">
                            ...
                            <span className="dr-login-hint">
                                Have an account?{" "}
                                <Link href={r("login")}>Sign in →</Link>
                            </span>
                        </div>
                        ...
                        <div className="dr-right-body">
                            <div className="dr-right-head">
                                ...
                                <p>
                                    Tell us a bit about your team and we'll set
                                    up a time to show you around.
                                </p>
                            </div>

                            {flash?.success && (
                                <div className="dr-alert-success">
                                    <div className="dr-alert-success-icon">
                                        ✓
                                    </div>
                            ...
                            {errorCount > 0 && (
                                <div className="dr-error-banner">
                                    <div className="dr-error-banner-icon">
                                        ⚠️
                                    </div>
                            ...
                            <div className="dr-panel">
                                <form onSubmit={submit}>
                                    <div className="dr-row">
                                        <div
                                            className={`dr-field${errors.full_name ? " has-error" : ""}`}
                                        >
                                            <label htmlFor="full_name">
                                                Full Name
                                                {errors.full_name && (
                                                    <span className="dr-field-error-tag">
                                                        {errors.full_name}
                                                    </span>
                                                )}
                                            </label>
                                        ...
                                        <div
                                            className={`dr-field${errors.work_email ? " has-error" : ""}`}
                                        >
                                    ...
                                    <div className="dr-row">
                                        <div
                                            className={`dr-field${errors.phone ? " has-error" : ""}`}
                                        >
                                            <label htmlFor="phone">
                                                Phone{" "}
                                                <span
                                        ...
                                        <div
                                            className={`dr-field${errors.role ? " has-error" : ""}`}
                                        >
                                            <label htmlFor="role">
                                                Your Role{" "}
                                                <span
                                    ...
                                    <div className="dr-row">
                                        <div
                                            className={`dr-field${errors.company_name ? " has-error" : ""}`}
                                        >
                                        ...
                                        <div
                                            className={`dr-field${errors.company_size ? " has-error" : ""}`}
                                        >
                                    ...
                                    <div className="dr-row">
                                        <div
                                            className={`dr-field${errors.preferred_date ? " has-error" : ""}`}
                                        >
                                        ...
                                        <div
                                            className={`dr-field${errors.preferred_time ? " has-error" : ""}`}
                                        >
                                    ...
                                    <div className="dr-row single">
                                        <div
                                            className={`dr-field${errors.message ? " has-error" : ""}`}
                                        >
                                    ...
                                    <p className="dr-note">
                                        ...
                                        by our team regarding your demo request.
                                        We won't share your details with third
                                        parties.
                                    </p>
                                </form>
                            </div>
