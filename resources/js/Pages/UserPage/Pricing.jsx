                        ...
                        <div className="row align-items-center">
                            <div className="col-lg-7">
                                <div className="pp-trial-image position-relative d-lg-block d-none text-center">
                                    <img
                                        src="/assets/img/home/jointeam.svg"
                                        alt="Join Future Connect"
                                        className="img-fluid"
                                    />
                                </div>
                            </div>
                            <div className="col-lg-5">
                                ...
                                <p>
                                    Access all basic features — no commitment
                                    required.
                                </p>
                                ...
                                <span className="pp-trial-note d-lg-block d-none">
                                    Takes less than 5 minutes — you stay in
                ...
                <section className="pp-price-section">
                    <div className="container">
                        <div className="pp-section-head">
                            ...
                            <p>
                                Pick the plan that fits how you work. Switch or
                                cancel anytime.
                            </p>
                        </div>
                        ...
                        <div className="pp-switch-wrap">
                            <div className="pp-billing-switch" role="tablist">
                                ...
                                <button
                                    ...
                                    className={
                                        billing === "annually" ? "active" : ""
                                    }
                                    onClick={() => setBilling("annually")}
                                >
                                    Yearly{" "}
                                    <span className="pp-save-tag">
                                        Save 20%
                                    </span>
                                </button>
                            </div>
                        ...
                        {visiblePlans.length === 0 ? (
                            ...
                            <div className="row justify-content-center">
                                {visiblePlans.map(({ plan, price }) => (
                                    ...
                                    >
                                        <div
                                            className={`pp-price-card${plan.is_featured ? " featured" : ""}`}
                                        >
                                            {plan.is_featured && (
                                                <span className="pp-featured-ribbon">
                                                    Most Popular
                                                </span>
                                            )}

                                            <h3 className="pp-plan-name">
                                                {plan.name}
                                            </h3>
                                            ...
                                            <div className="pp-features-label">
                                                Includes
                                            </div>
                        ...
                        <form onSubmit={submitSubscribe}>
                            <div className="modal-body">
                                ...
                                <div className="pp-modal-alert mt-3">
                                    This plan will be activated immediately
                                    after confirmation.
                                </div>
                            </div>
