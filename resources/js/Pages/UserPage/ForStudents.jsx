...
/**
 * ForStudents (Inertia page component)
 * --------------------------------------
 * React/Inertia port of the Blade "For Students" solutions page.
 *
 ...
 * - The original page had no light theme at all — every color was a
 *   hardcoded dark hex value in `:root`, so the header's theme toggle had
 *   nothing to switch on this page. This version moves those variables
 *   under `.fc-sol-page` (dark default, matching the site's dark theme)
 *   and adds a `[data-h-theme="light"]` override block, the same pattern
 *   used on every other converted page — so toggling the header's switch
          ...
          <div className="container">
            <div className="row align-items-center g-5">
              <div className="col-lg-7">
                <span className="fc-sol-eyebrow"><i className="ti ti-school" /> For Students</span>
                <h1>Launch your career with <span>confidence</span></h1>
                <p className="lead">
                  Build a verified skills profile, learn from short affordable courses, connect with mentors, and
                  land your first real opportunity — all in one platform designed for students entering the job
                  market.
                </p>
        ...
        <section className="fc-sol-section">
          <div className="container">
            <div className="row g-4 mb-5">
              <div className="col-lg-8">
                <div className="fc-stats-bar h-100">
                  <div className="row">
                    <div className="col-4 fc-stat-item"><strong>8K+</strong><span>Skills available</span></div>
                    <div className="col-4 fc-stat-item"><strong>3×</strong><span>Employer reach</span></div>
                    <div className="col-4 fc-stat-item"><strong>100%</strong><span>Verified profiles</span></div>
                  </div>
                </div>
              </div>
            ...
            <div className="fc-testimonial">
              ...
              <p className="quote">
                Building my verified profile on Future Connect got me noticed by a company I never thought would
                reply to a student. Three weeks later I had my first freelance contract.
              </p>
