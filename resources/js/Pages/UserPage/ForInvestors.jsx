...
/**
 * "For Investors" solutions page — mostly static marketing content.
 *
 * NOTE ON ROUTES: the "#" links below (Get in touch, View platform metrics,
 * Contact us) were placeholders in the Blade original. Swap them for real
 * routes/mailto when ready.
 */
    ...
    const benefits = [
        {
            ...
            text: 'Skills listed, active users, and verified professionals — transparent platform traction.',
        },
        {
            icon: 'ti-trending-up',
            title: 'Emerging skill trends',
            text: 'See which skills and sectors are gaining traction by region in near real time.',
        },
        {
            icon: 'ti-bulb',
            title: 'Marketplace signals',
            text: 'Identify which sellers and creators are gaining early traction in the products marketplace.',
        },
        {
            icon: 'ti-handshake',
            title: 'Partnership access',
            text: 'Direct line to the Future Connect team for investment and partnership conversations.',
        },
    ];

    const trends = [
        { name: 'Digital Marketing', growth: '+38%', width: 80 },
        { name: 'Software Development', growth: '+31%', width: 70 },
        { name: 'Writing & Content', growth: '+22%', width: 55 },
        { name: 'Design & Creative', growth: '+19%', width: 48 },
    ];
            ...
            <div className="fc-sol-page">
                        ...
                        <div className="row align-items-center g-5">
                            <div className="col-lg-7">
                                <span className="fc-sol-eyebrow">
                                    <i className="ti ti-chart-line" /> For Investors
                                </span>
                                <h1>
                                    Discover skills <span>worth investing in</span>
                                </h1>
                                <p className="lead">
                                    Get visibility into a growing talent marketplace — emerging skill trends,
                                    platform traction, and where real economic opportunity is forming.
                                </p>
                                <div className="d-flex gap-3 flex-wrap">
                                    <Link href={routes.contact} className="btn-fc-primary">
                                        <i className="ti ti-mail" /> Get in touch
                                    </Link>
                                    <Link href={routes.metrics} className="btn-fc-ghost">
                                        <i className="ti ti-chart-bar" /> View platform metrics
                                    </Link>
                                </div>
                            </div>
                ...
                <section className="fc-sol-section">
                    <div className="container">
                        <div className="fc-sol-header">
                            <h2>
                                Signal, not <span>guesswork</span>
                            </h2>
                ...
                <section className="fc-sol-section alt">
                    <div className="container">
                        <div className="fc-sol-header">
                            <h2>
                                Trending <span>skill categories</span>
                            </h2>
                            <p>A snapshot of demand growth across the platform.</p>
                        </div>
                        <div className="fc-trend-list">
                            {trends.map((trend) => (
                                <div className="fc-trend-row" key={trend.name}>
                                    <span className="fc-trend-name">{trend.name}</span>
                                    <div className="d-flex align-items-center">
                                        <span className="fc-trend-badge">
                                            <i className="ti ti-arrow-up" /> {trend.growth}
                                        </span>
                                        <div className="fc-trend-bar-wrap">
                                            <div className="fc-trend-bar-fill" style={{ width: `${trend.width}%` }} />
                                        </div>
                                    </div>
                                </div>
                            ))}
                        ...
                        <div className="row g-4 mb-5">
                            ...
                            <div className="col-lg-4">
                                <div className="fc-final-cta h-100 d-flex flex-column justify-content-center mb-0 py-4">
                                    <h2 className="h5 mb-2">Let's talk</h2>
                                    <Link href={routes.contact} className="btn-fc-primary justify-content-center">
                                        Contact us
                                    </Link>
                                </div>
                            </div>
...
ForInvestors.layout = (page) => (
  <GuestLayout children={page} title="For Investors - Future Connect" />
);