...
export default function StartConnecting({ categories = [] }) {
  ...
  return (
    <>
      <Head title="Start Connecting – Get Discovered. Get Hired. Get Growing." />
      ...
      <div className="container d-lg-none py-5">
        <div className="mb-3">
          <div className="section-label">Find Your Fit, start connecting here</div>
...
StartConnecting.layout = (page) => <GuestLayout children={page} title="Skills Marketplace" description="Join 74,000+ skilled people getting discovered by employers and clients across Africa. Create your free profile today." />;