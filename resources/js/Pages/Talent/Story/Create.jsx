...
export default function Create({ talent, categories }) {
    ...
    function submit(e) {
        e.preventDefault();
        post(route("talent.page.stories.store"), { forceFormData: true });
    }

    return (
        <AppLayout>
            <Head title="Add Your Story" />
            ...
            <div data-h-scope="talent-story-form">
                ...
                <div className="container-fluid px-4 py-4">
                    <div className="d-flex align-items-center justify-content-between mb-4">
                        <h5 className="fw-bold mb-0">Add Your Story</h5>
                        <Link
                            href={route("talent.get.profile", talent.id)}
