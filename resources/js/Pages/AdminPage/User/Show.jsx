                    ...
                    <div className="col-12 col-lg-3">
                        <div className="ui-card profile-card">
                            ...
                            <div className="stats-row">
                                ...
                                <div className="stat">
                                    <div
                                        className={`stat-val ${user.active ? "is-active" : "is-inactive"}`}
                                    >
                            ...
                            {activeTab === "personal" && (
                                <div className="tab-pane">
                                    ...
                                    <div className="data-row">
                                        ...
                                        <div className="data-value">
                                            <span
                                                className={`status-chip ${user.active ? "chip-active" : "chip-inactive"}`}
                                            >
                                                {user.active
                                                    ? "Active"
                                                    : "Inactive"}
...
function BellOffIcon(p) {
    return (
        <svg {...svgProps({ size: 32, ...p })}>
...
function ProfileStyles() {
    return (
        <style>{`
            ...
            .back-link:hover { color: var(--accent-ink); gap: 9px; }
            ...
            .record-tag {
                ...
                background: var(--ink); padding: 5px 12px 5px 14px;
            ...
            .stat-val { color: var(--ink); font-size: 14px; font-weight: 600; font-variant-numeric: tabular-nums; }
            .stat-val.is-active   { color: var(--accent-ink); }
            .stat-val.is-inactive { color: var(--ink-faint); }
            ...
            .edit-inline-btn:hover { border-color: var(--ink); color: #fff; background: var(--ink); }

            .section-head {
                padding: 11px 28px; font-size: 10.5px; font-weight: 600;
            ...
            .status-chip::before { content: ''; width: 7px; height: 7px; border-radius: 50%; box-sizing: border-box; }
            .chip-active   { color: var(--accent-ink); } .chip-active::before   { background: var(--accent); }
            .chip-inactive { color: var(--ink-faint);  } .chip-inactive::before { background: transparent; border: 1.5px solid var(--ink-faint); }
            ...
            .warn-box {
                ...
                color: var(--ink-2); font-size: 13.5px; align-items: flex-start;
            }
            .warn-box svg { color: var(--ink); flex-shrink: 0; margin-top: 1px; }
