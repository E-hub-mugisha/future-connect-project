...
/* ── Inline icon set (replaces Tabler `ni` icon classes) ── */
const Icon = {
    Package: (p) => (
...
export default function Create({ sellers = [], categories = [] }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(routes.productsStore, { forceFormData: true });
    };
    ...
    return (
        <div data-h-scope="product-create">
            ...
            <div className="p-wrap">
                <div className="p-header">
                    <span className="p-eyebrow"><Icon.Package style={{ width: 13, height: 13 }} /> Catalog</span>
                    <h1>Add a new product</h1>
                    <p>Fill in the details below to list a new item in the shop catalog.</p>
                </div>
                ...
                <form onSubmit={submit}>
                    <div className="p-card">
                        ...
                        <div className="p-section">
                            ...
                            <div className="p-grid">
                                ...
                                <Field label="Seller" icon={<Icon.User />}>
                                    <div className="p-select-wrap">
                                        ...
                                        >
                                            ...
                                            {sellers.map((s) => (
                                                <option value={s.id} key={s.id}>{s.company_name}</option>
                                            ))}
                                        </select>
                                        <svg className="p-select-caret" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="m6 9 6 6 6-6" /></svg>
                                    </div>
                                    {errors.seller_id && <p className="p-error">{errors.seller_id}</p>}
                                </Field>

                                <Field label="Category" icon={<Icon.Tag />}>
                                    <div className="p-select-wrap">
                                        <select
                                            className="p-select"
                                ...
                                {!preview ? (
                                    ...
                                    <div className="p-preview">
                                        ...
                                        <div className="p-preview-meta">
                                            <p className="p-preview-name">{data.image?.name}</p>
                                            <p className="p-preview-size">
                                                {data.image ? `${(data.image.size / 1024).toFixed(0)} KB` : ''}
                                            </p>
                                        </div>
                    ...
                    <div className="p-footer">
                        ...
                        <button type="submit" className="p-btn-primary" disabled={processing}>
                            <Icon.Save /> {processing ? 'Saving…' : 'Save product'}
                        </button>
                    </div>
                </form>
            </div>
...
Create.layout = (page) => <AppLayout children={page} title="Add New Product" />;
