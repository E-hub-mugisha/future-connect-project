import{d as b,u as v,j as e,H as f}from"./app-BV2sDVKx.js";import{G as j}from"./GuestLayout-zw3aPGz3.js";const y=[{value:"corporate",label:"Corporate"},{value:"ngo",label:"NGO / Development Partner"},{value:"academic",label:"Academic / Training Institution"},{value:"government",label:"Government Agency"},{value:"other",label:"Other"}],N=[{value:"hiring",label:"Talent Hiring"},{value:"training",label:"Training Programs"},{value:"funding",label:"Program Funding"},{value:"internships",label:"Internships"},{value:"events",label:"Joint Events"},{value:"other_interest",label:"Other"}];function w(){const{flash:t,partners:c=[]}=b().props,{data:s,setData:i,post:d,processing:o,errors:a,reset:h}=v({organization_name:"",partnership_type:"",contact_name:"",contact_role:"",email:"",phone:"",website:"",interests:[],message:""}),g=r=>{i("interests",s.interests.includes(r)?s.interests.filter(p=>p!==r):[...s.interests,r])},x=r=>{r.preventDefault(),d("/partnerships/apply",{onSuccess:()=>h()})};return e.jsxs("div",{className:"partnerships-page",children:[e.jsx(f,{title:"Partnerships — Future Connect"}),e.jsx("style",{children:`
                .partnerships-page {
                    --p-bg-primary: #0e1618;
