import{r as c,u as C,j as e,H as q,L as t,R as z,d as M}from"./app-DAdnLqM_.js";import{G as A}from"./GuestLayout-DypAKmPK.js";function R({categories:l=[]}){const[f,v]=c.useState(null),[o,m]=c.useState(0),[T,d]=c.useState(!1),[I,b]=c.useState(!1),[h,u]=c.useState({keyword:"",category:""}),{data:n,setData:i,post:j,processing:N,errors:r,reset:y}=C({name:"",address:"",phone:"",email:"",language:"",category_id:"",description:"",image:null}),p=4;function w(a){v(s=>s===a?null:a)}function g(){m(a=>Math.min(a+1,p-1))}function x(){m(a=>Math.max(a-1,0))}function k(a){a.preventDefault(),M.get(route("user.talents"),h),d(!1)}function S(a){a.preventDefault(),j(route("talent.register"),{forceFormData:!0,onSuccess:()=>{y(),m(0),b(!1)}})}return e.jsxs(e.Fragment,{children:[e.jsx(q,{title:"Skilled Marketplace – Discover Skilled Professionals"}),e.jsx("link",{rel:"stylesheet",href:"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css"}),e.jsx("link",{href:"https://fonts.googleapis.com/css2?family=Syne:wght@400;600;700;800&family=DM+Sans:wght@300;400;500&display=swap",rel:"stylesheet"}),e.jsx("style",{children:`
        :root {
          --bg:        #0e1618;
          --bg2:       #131d20;
          --bg3:       #18242a;
