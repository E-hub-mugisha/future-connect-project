import{r as S,u as z,j as e,H as A,L as F}from"./app-DQcVR1sC.js";import{G as D}from"./GuestLayout-AyS9Rfgz.js";function P({product:r}){var m,b,h,g,v,p,x,f,u,y,j;const[o,l]=S.useState("description"),[d,c]=S.useState(0),t=z({rating:"",comment:""}),i=z({quantity:1});function R(a){a.preventDefault(),t.post(route("product.reviews.store",r.id),{preserveScroll:!0,onSuccess:()=>t.reset()})}function C(a){a.preventDefault(),i.post(route("cart.add",r.id),{preserveScroll:!0})}function B(){i.setData("quantity",Math.max(1,i.data.quantity-1))}function q(){const a=r.stock??1e3;i.setData("quantity",Math.min(a,Number(i.data.quantity)+1))}const n=r.reviews&&r.reviews.length?r.reviews.reduce((a,s)=>a+s.rating,0)/r.reviews.length:0,M=(Number(r.price)*Number(i.data.quantity||1)).toFixed(2);return e.jsxs(e.Fragment,{children:[e.jsx(A,{title:r.name}),e.jsx("style",{children:`
        :root {
          --bg-deep:    #0e1618;
          --bg-card:    #121d1f;
          --bg-raised:  #172224;
      ...
      `}),e.jsxs("div",{className:"pd-wrapper",children:[e.jsxs("div",{className:"breadcrumb-row",children:[e.jsx("a",{href:"#",children:"Home"})," ",e.jsx("i",{className:"fa-solid fa-chevron-right",style:{fontSize:".65rem"}}),e.jsx("a",{href:"#",children:"Marketplace"})," ",e.jsx("i",{className:"fa-solid fa-chevron-right",style:{fontSize:".65rem"}}),e.jsx(F,{href:route("user.product.category",((m=r.category)==null?void 0:m.id)??"#"),children:((b=r.category)==null?void 0:b.name)??"Products"}),e.jsx("i",{className:"fa-solid fa-chevron-right",style:{fontSize:".65rem"}}),e.jsx("span",{children:r.name})]}),e.jsxs("div",{className:"pd-grid",children:[e.jsx("div",{className:"pd-sidebar-col",children:e.jsxs("div",{className:"sidebar-card",children:[e.jsxs("div",{className:"price-block",children:[e.jsx("div",{className:"price-label",children:"Price"}),e.jsxs("div",{className:"price-amount",children:[Number(r.price).toLocaleString(),e.jsx("span",{className:"price-currency",children:"RWF"})]}),e.jsxs(F,{href:route("checkout.create",r.slug),className:"btn-buy-now",children:[e.jsx("i",{className:"feather-shopping-cart"})," ","Buy This Product"]})]}),e.jsxs("div",{className:"seller-block",children:[e.jsxs("div",{className:"seller-header",children:[e.jsx("img",{src:"/assets/img/user/user-05.jpg",alt:"Seller",className:"seller-avatar"}),e.jsxs("div",{children:[e.jsx("div",{className:"seller-name",children:(h=r.seller)==null?void 0:h.company_name}),e.jsx("div",{className:"seller-online",children:"Online"})]})]}),e.jsxs("ul",{className:"meta-list",children:[e.jsxs("li",{children:[e.jsx("i",{className:"ti ti-tag"}),e.jsxs("div",{children:[e.jsx("div",{className:"meta-key",children:"Category"}),e.jsx("div",{className:"meta-val",children:((g=r.category)==null?void 0:g.name)??"Uncategorized"})]})]}),e.jsxs("li",{children:[e.jsx("i",{className:"ti ti-user"}),e.jsxs("div",{children:[e.jsx("div",{className:"meta-key",children:"Seller"}),e.jsx("div",{className:"meta-val",children:(v=r.seller)==null?void 0:v.company_name})]})]}),e.jsxs("li",{children:[e.jsx("i",{className:"ti ti-calendar-check"}),e.jsxs("div",{children:[e.jsx("div",{className:"meta-key",children:"Listed"}),e.jsx("div",{className:"meta-val",children:r.listed_ago??"—"})]})]}),e.jsxs("li",{children:[e.jsx("i",{className:"ti ti-stack"}),e.jsxs("div",{children:[e.jsx("div",{className:"meta-key",children:"Stock / Queue"}),e.jsxs("div",{className:"meta-val",children:[r.stock," units"]})]})]}),e.jsxs("li",{children:[e.jsx("i",{className:"ti ti-star"}),e.jsxs("div",{children:[e.jsx("div",{className:"meta-key",children:"Rating"}),e.jsxs("div",{className:"meta-val",children:[n.toFixed(1)," / 5 (",((p=r.reviews)==null?void 0:p.length)??0," ","reviews)"]})]})]})]}),e.jsxs("a",{href:"#",className:"btn-contact","data-bs-toggle":"modal","data-bs-target":"#contact_me",children:[e.jsx("i",{className:"feather-message-circle"})," ","Contact Seller"]})]})]})}),e.jsxs("div",{className:"pd-content-col",children:[e.jsxs("div",{className:"product-image-panel",style:{marginBottom:"1.5rem"},children:[e.jsx("img",{src:"/assets/img/service/service-slide-01.jpg",alt:r.name,className:"product-main-img"}),e.jsx("div",{className:"product-img-glow"})]}),e.jsxs("div",{style:{background:"var(--bg-card)",border:"1px solid var(--border)",borderRadius:"18px",overflow:"hidden"},children:[e.jsxs("div",{className:"tab-nav",children:[e.jsx("button",{className:`tab-btn${o==="description"?" active":""}`,onClick:()=>l("description"),children:"Description"}),e.jsxs("button",{className:`tab-btn${o==="reviews"?" active":""}`,onClick:()=>l("reviews"),children:["Reviews (",((x=r.reviews)==null?void 0:x.length)??0,")"]})]}),e.jsx("div",{className:`tab-pane${o==="description"?" active":""}`,children:e.jsxs("div",{className:"description-section",children:[e.jsx("h3",{children:"About this product"}),e.jsx("p",{children:r.description})]})}),e.jsxs("div",{className:`tab-pane${o==="reviews"?" active":""}`,children:[e.jsxs("div",{className:"review-header",children:[e.jsx("h3",{children:"Customer Reviews"}),e.jsxs("a",{href:"#",className:"btn-write-review","data-bs-toggle":"modal","data-bs-target":"#addReviewModal",children:[e.jsx("i",{className:"fa-solid fa-pen"})," ","Write a Review"]})]}),e.jsxs("div",{className:"rating-summary",children:[e.jsx("div",{className:"big-score",children:n.toFixed(1)}),e.jsx("div",{className:"out-of",children:"out of 5.0"}),e.jsx("div",{className:"stars",children:Array.from({length:5}).map((a,s)=>e.jsx("i",{className:"fa-solid fa-star",style:{color:s<Math.round(n)?"#f59e0b":"#2a3d3a"}},s))}),e.jsxs("p",{children:["Based on ",((f=r.reviews)==null?void 0:f.length)??0," ","reviews"]})]}),(u=r.reviews)==null?void 0:u.map(a=>{var s,w,N;return e.jsxs("div",{className:"review-item",children:[e.jsxs("div",{className:"review-user",children:[e.jsx("img",{src:((s=a.user)==null?void 0:s.profile_photo_url)??"/assets/img/default-avatar.png",alt:(w=a.user)==null?void 0:w.name,className:"review-avatar"}),e.jsxs("div",{children:[e.jsx("div",{className:"review-user-name",children:(N=a.user)==null?void 0:N.name}),e.jsx("div",{className:"review-time",children:a.created_ago})]}),e.jsx("div",{className:"review-stars ms-auto",children:Array.from({length:5}).map((H,k)=>e.jsx("i",{className:"fa-solid fa-star",style:{color:k<a.rating?"#f59e0b":"#2a3d3a"}},k))})]}),e.jsx("p",{className:"review-text",children:a.comment})]},a.id)})]})]})]})]})]}),e.jsx("div",{className:"modal fade",id:"addReviewModal",tabIndex:"-1","aria-hidden":"true",children:e.jsx("div",{className:"modal-dialog modal-dialog-centered",children:e.jsxs("div",{className:"modal-content",children:[e.jsx("div",{style:{background:"linear-gradient(135deg,#0a2e22,#0d3d29)",padding:"1.5rem 2rem",borderRadius:"18px 18px 0 0",borderBottom:"1px solid rgba(0,166,103,.2)"},children:e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between"},children:[e.jsx("h5",{style:{fontFamily:"-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Helvetica Neue', Arial, sans-serif",fontWeight:800,color:"#fff",margin:0},children:"Leave a Review"}),e.jsx("button",{type:"button",className:"btn-close btn-close-white","data-bs-dismiss":"modal"})]})}),e.jsxs("form",{onSubmit:R,children:[e.jsxs("div",{className:"modal-body p-4",children:[e.jsxs("div",{className:"mb-4",children:[e.jsx("label",{className:"form-label",style:{color:"var(--muted)",fontSize:".85rem",display:"block",marginBottom:".75rem"},children:"Your Rating"}),e.jsx("div",{className:"star-select-row",children:[1,2,3,4,5].map(a=>e.jsx("i",{className:Number(t.data.rating)>=a||d>=a?"fa-solid fa-star":"fa-regular fa-star",style:{color:Number(t.data.rating)>=a||d>=a?"#f59e0b":"var(--muted)"},onMouseEnter:()=>c(a),onMouseLeave:()=>c(0),onClick:()=>t.setData("rating",a)},a))}),t.errors.rating&&e.jsx("small",{className:"text-danger d-block mt-1",children:t.errors.rating})]}),e.jsxs("div",{className:"mb-3",children:[e.jsx("label",{className:"form-label",children:"Your Review"}),e.jsx("textarea",{className:"form-control",rows:"4",placeholder:"Share your experience with this product...",value:t.data.comment,onChange:a=>t.setData("comment",a.target.value),required:!0}),t.errors.comment&&e.jsx("small",{className:"text-danger d-block mt-1",children:t.errors.comment})]})]}),e.jsx("div",{className:"modal-footer",style:{borderTop:"1px solid var(--border)",padding:"1.25rem 2rem"},children:e.jsx("button",{type:"submit",className:"btn-accent w-100",disabled:t.processing,children:"Submit Review"})})]})]})})}),e.jsx("div",{className:"modal fade",id:`addToCartModal${r.id}`,tabIndex:"-1","aria-hidden":"true",children:e.jsx("div",{className:"modal-dialog modal-dialog-centered modal-lg",children:e.jsxs("div",{className:"modal-content",children:[e.jsxs("div",{style:{background:"linear-gradient(135deg,#0a2e22,#0d3d29)",padding:"1.25rem 2rem",borderRadius:"18px 18px 0 0",borderBottom:"1px solid rgba(0,166,103,.2)",display:"flex",alignItems:"center",justifyContent:"space-between"},children:[e.jsx("h5",{style:{fontFamily:"-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Helvetica Neue', Arial, sans-serif",fontWeight:800,color:"#fff",margin:0,fontSize:"1rem"},children:"Add to Cart"}),e.jsx("button",{type:"button",className:"btn-close btn-close-white","data-bs-dismiss":"modal"})]}),e.jsx("form",{onSubmit:C,children:e.jsx("div",{className:"modal-body p-4",children:e.jsxs("div",{className:"row g-4",children:[e.jsx("div",{className:"col-md-5",children:e.jsx("img",{src:`/storage/${r.image}`,alt:r.name,className:"cart-product-img"})}),e.jsxs("div",{className:"col-md-7",children:[e.jsx("h4",{style:{fontFamily:"-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Helvetica Neue', Arial, sans-serif",fontWeight:800,color:"var(--white)",marginBottom:".5rem"},children:r.name}),e.jsx("p",{style:{color:"var(--muted)",fontSize:".9rem",marginBottom:"1rem"},children:r.description}),e.jsxs("div",{style:{display:"flex",gap:".5rem",marginBottom:"1rem"},children:[e.jsx("span",{style:{background:"var(--accent-dim)",border:"1px solid rgba(0,166,103,.3)",color:"var(--accent)",fontSize:".75rem",fontWeight:700,padding:".2rem .65rem",borderRadius:"50px"},children:((y=r.category)==null?void 0:y.name)??"General"}),e.jsx("span",{style:{background:"var(--bg-raised)",border:"1px solid var(--border)",color:"var(--muted)",fontSize:".75rem",fontWeight:600,padding:".2rem .65rem",borderRadius:"50px"},children:((j=r.seller)==null?void 0:j.company_name)??"N/A"})]}),e.jsxs("p",{style:{fontSize:".85rem",color:"var(--muted)",marginBottom:"1.25rem"},children:["In Stock:"," ",e.jsx("strong",{style:{color:"var(--text)"},children:r.stock??"Unlimited"})]}),e.jsxs("div",{style:{marginBottom:"1.25rem"},children:[e.jsx("label",{style:{fontSize:".8rem",color:"var(--muted)",display:"block",marginBottom:".6rem"},children:"Quantity"}),e.jsxs("div",{className:"qty-control",children:[e.jsx("button",{type:"button",className:"qty-btn",onClick:B,children:"−"}),e.jsx("input",{type:"number",className:"qty-num",min:"1",max:r.stock??1e3,value:i.data.quantity,onChange:a=>i.setData("quantity",Math.max(1,Number(a.target.value)||1))}),e.jsx("button",{type:"button",className:"qty-btn",onClick:q,children:"+"})]})]}),e.jsxs("div",{style:{background:"var(--bg-raised)",border:"1px solid var(--border)",borderRadius:"12px",padding:"1rem",marginBottom:"1.5rem",display:"flex",justifyContent:"space-between",alignItems:"center"},children:[e.jsx("span",{style:{color:"var(--muted)",fontSize:".85rem"},children:"Total Amount"}),e.jsxs("span",{style:{fontFamily:"-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Helvetica Neue', Arial, sans-serif",fontSize:"1.3rem",fontWeight:800,color:"var(--white)"},children:["$",M]})]}),e.jsxs("div",{style:{display:"flex",gap:".75rem"},children:[e.jsx("button",{type:"button",className:"btn-contact","data-bs-dismiss":"modal",style:{flex:1},children:"Cancel"}),e.jsxs("button",{type:"submit",className:"btn-accent",style:{flex:2,padding:".8rem"},disabled:i.processing,children:[e.jsx("i",{className:"feather-shopping-cart"})," ","Add to Cart"]})]})]})]})})})]})})})]})}P.layout=r=>e.jsx(D,{children:r,title:r.props.product.name});export{P as default};
