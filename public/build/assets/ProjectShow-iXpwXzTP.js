import{u as c,j as e,H as m,L as f}from"./app-B7IJkTeC.js";import{G as b}from"./GuestLayout-Dmb6shQU.js";function h({project:r,recent:t=[]}){var l;const s=c({message:"",amount:"",currency:"USD"}),o=c({message:"",portfolio_url:"",attachment:null});function d(a){a.preventDefault(),s.post(route("diaspora.sponsorship.store",r.id))}function i(a){a.preventDefault(),o.post(route("user.projects.apply",r.id),{forceFormData:!0})}return e.jsxs(e.Fragment,{children:[e.jsx(m,{title:r.title}),e.jsx("style",{children:`
        :root{
          --fc-bg:#0e1618;
          --fc-bg-alt:#141d20;
          --fc-card:#172124;
      ...
      `}),e.jsx("div",{className:"fc-page",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"row g-4",children:[e.jsx("div",{className:"col-lg-8",children:e.jsxs("div",{className:"fc-card",children:[e.jsxs("div",{className:"fc-proj-header",children:[e.jsxs("div",{className:"d-flex align-items-center justify-content-between flex-wrap gap-2",children:[e.jsx("h2",{children:r.title}),r.verified&&e.jsxs("span",{className:"fc-badge-verified",children:[e.jsx("i",{className:"bi bi-patch-check-fill me-1"})," Verified"]})]}),e.jsxs("p",{className:"fc-proj-meta mb-0",children:[e.jsx("i",{className:"bi bi-person-circle me-1"})," ",((l=r.user)==null?void 0:l.name)??"Unknown"," • ",e.jsx("i",{className:"bi bi-geo-alt me-1"})," ",r.location??"Remote"," • ",e.jsx("i",{className:"bi bi-briefcase me-1"})," ",r.category??"General"]})]}),e.jsxs("div",{className:"fc-proj-body",children:[e.jsx("p",{className:"fc-proj-desc",children:r.description}),e.jsxs("div",{className:"row g-3 mb-4",children:[e.jsx("div",{className:"col-md-4",children:e.jsxs("div",{className:"fc-info-box",children:[e.jsx("small",{children:"💰 Budget"}),e.jsx("span",{children:r.budget})]})}),e.jsx("div",{className:"col-md-4",children:e.jsxs("div",{className:"fc-info-box",children:[e.jsx("small",{children:"📊 Status"}),e.jsx("span",{children:p(r.status)})]})}),e.jsx("div",{className:"col-md-4",children:e.jsxs("div",{className:"fc-info-box",children:[e.jsx("small",{children:"🕒 Posted"}),e.jsx("span",{children:r.posted_ago})]})})]}),e.jsxs("div",{className:"d-flex gap-2 flex-wrap",children:[e.jsxs("button",{className:"btn btn-fc-primary","data-bs-toggle":"modal","data-bs-target":"#applyModal",children:[e.jsx("i",{className:"bi bi-envelope-paper me-2"})," Apply for Collaboration"]}),e.jsx("button",{type:"button",className:"btn btn-fc-outline-primary","data-bs-toggle":"modal","data-bs-target":"#sponsorModal",children:"Sponsor This Project"})]}),e.jsx("div",{className:"modal fade",id:"sponsorModal",tabIndex:"-1","aria-labelledby":"sponsorModalLabel","aria-hidden":"true",children:e.jsx("div",{className:"modal-dialog modal-dialog-centered",children:e.jsxs("div",{className:"modal-content",children:[e.jsxs("div",{className:"modal-header",children:[e.jsxs("h5",{className:"modal-title fw-bold",id:"sponsorModalLabel",children:["Sponsor: ",r.title]}),e.jsx("button",{type:"button",className:"btn-close btn-close-white","data-bs-dismiss":"modal","aria-label":"Close"})]}),e.jsxs("div",{className:"modal-body",children:[Object.keys(s.errors).length>0&&e.jsxs("div",{className:"alert alert-danger",children:[e.jsx("h6",{className:"mb-2 fw-bold",children:"❗ Please fix the following errors:"}),e.jsx("ul",{className:"mb-0",children:Object.values(s.errors).map((a,n)=>e.jsx("li",{children:a},n))})]}),e.jsx("p",{className:"text-muted mb-4",style:{color:"var(--fc-muted)"},children:r.description}),e.jsxs("form",{id:"sponsorForm",onSubmit:d,children:[e.jsxs("div",{className:"col-12 mb-3",children:[e.jsx("label",{className:"form-label",children:"Message"}),e.jsx("textarea",{name:"message",rows:"4",className:"form-control",placeholder:"Leave a message...",value:s.data.message,onChange:a=>s.setData("message",a.target.value)})]}),e.jsxs("div",{className:"mb-3",children:[e.jsx("label",{className:"form-label",children:"Amount"}),e.jsx("input",{type:"number",name:"amount",className:`form-control${s.errors.amount?" is-invalid":""}`,value:s.data.amount,onChange:a=>s.setData("amount",a.target.value),required:!0}),s.errors.amount&&e.jsx("div",{className:"invalid-feedback",children:s.errors.amount})]}),e.jsxs("div",{className:"mb-3",children:[e.jsx("label",{className:"form-label",children:"Currency"}),e.jsxs("select",{name:"currency",className:`form-select${s.errors.currency?" is-invalid":""}`,value:s.data.currency,onChange:a=>s.setData("currency",a.target.value),children:[e.jsx("option",{value:"USD",children:"USD"}),e.jsx("option",{value:"EUR",children:"EUR"}),e.jsx("option",{value:"RWF",children:"RWF"})]}),s.errors.currency&&e.jsx("div",{className:"invalid-feedback",children:s.errors.currency})]}),e.jsx("button",{type:"submit",className:"btn btn-fc-primary w-100",disabled:s.processing,children:"Sponsor Now"})]})]})]})})})]})]})}),e.jsxs("div",{className:"col-lg-4",children:[e.jsxs("div",{className:"fc-card mb-4",children:[e.jsxs("div",{className:"fc-sidebar-header",children:[e.jsx("i",{className:"bi bi-stars me-2"})," Recent Projects"]}),e.jsx("div",{children:t.map(a=>e.jsxs(f,{href:route("user.projects.show",a.id),className:"fc-recent-item",children:[e.jsxs("div",{children:[e.jsx("h6",{className:"mb-1",children:a.title}),e.jsxs("small",{children:[e.jsx("i",{className:"bi bi-tag me-1"}),a.category??"General"]})]}),a.verified&&e.jsx("i",{className:"bi bi-patch-check-fill verified-icon"})]},a.id))})]}),e.jsx("div",{className:"fc-card",children:e.jsxs("div",{className:"fc-cta-card",children:[e.jsx("h6",{className:"mb-2",children:"Want to post your own project?"}),e.jsx("p",{className:"mb-3",children:"Share your idea and find talented collaborators."}),e.jsxs("a",{href:"#",className:"btn btn-fc-outline-primary",children:[e.jsx("i",{className:"bi bi-plus-circle me-1"})," Post a Project"]})]})})]})]})})}),e.jsx("div",{className:"modal fade",id:"applyModal",tabIndex:"-1","aria-labelledby":"applyModalLabel","aria-hidden":"true",children:e.jsx("div",{className:"modal-dialog modal-dialog-centered modal-lg",children:e.jsxs("div",{className:"modal-content overflow-hidden",children:[e.jsxs("div",{className:"modal-header p-4",children:[e.jsxs("div",{children:[e.jsxs("h5",{className:"modal-title fw-bold mb-1",children:[e.jsx("i",{className:"bi bi-envelope-paper me-2",style:{color:"var(--fc-accent)"}})," Apply for Collaboration"]}),e.jsx("small",{children:"Connect with this project by sharing your skills and experience"})]}),e.jsx("button",{type:"button",className:"btn-close btn-close-white","data-bs-dismiss":"modal"})]}),e.jsxs("form",{onSubmit:i,className:"p-3 p-md-4",children:[e.jsxs("div",{className:"modal-body",children:[e.jsxs("div",{className:"mb-4",children:[e.jsxs("label",{className:"form-label",children:[e.jsx("i",{className:"bi bi-chat-dots me-1",style:{color:"var(--fc-accent)"}})," Message / Collaboration Proposal"]}),e.jsx("textarea",{name:"message",className:"form-control p-3",rows:"4",placeholder:"Tell us about your expertise and how you can contribute...",value:o.data.message,onChange:a=>o.setData("message",a.target.value),required:!0}),o.errors.message&&e.jsx("div",{className:"text-danger small mt-1",children:o.errors.message})]}),e.jsxs("div",{className:"mb-4",children:[e.jsxs("label",{className:"form-label",children:[e.jsx("i",{className:"bi bi-link-45deg me-1",style:{color:"var(--fc-accent)"}})," Portfolio URL (optional)"]}),e.jsx("input",{type:"url",name:"portfolio_url",className:"form-control p-3",placeholder:"https://yourportfolio.com",value:o.data.portfolio_url,onChange:a=>o.setData("portfolio_url",a.target.value)}),o.errors.portfolio_url&&e.jsx("div",{className:"text-danger small mt-1",children:o.errors.portfolio_url})]}),e.jsxs("div",{className:"mb-2",children:[e.jsxs("label",{className:"form-label",children:[e.jsx("i",{className:"bi bi-paperclip me-1",style:{color:"var(--fc-accent)"}})," Attach File (optional)"]}),e.jsxs("div",{className:"file-upload-box p-4 rounded-4 text-center",children:[e.jsx("input",{type:"file",name:"attachment",className:"form-control form-control-sm border-0",accept:".pdf,.doc,.docx,.zip",onChange:a=>o.setData("attachment",a.target.files[0])}),e.jsx("small",{className:"d-block mt-2",style:{color:"var(--fc-muted)"},children:"Accepted: PDF, DOC, DOCX, ZIP — Max 2MB"})]}),o.errors.attachment&&e.jsx("div",{className:"text-danger small mt-1",children:o.errors.attachment})]})]}),e.jsxs("div",{className:"modal-footer d-flex justify-content-between px-4 pb-4",children:[e.jsxs("button",{type:"button",className:"btn btn-light","data-bs-dismiss":"modal",children:[e.jsx("i",{className:"bi bi-x-circle me-1"})," Cancel"]}),e.jsxs("button",{type:"submit",className:"btn btn-fc-primary px-5",disabled:o.processing,children:[e.jsx("i",{className:"bi bi-send-check me-1"})," Submit Application"]})]})]})]})})})]})}function p(r){return r?r.charAt(0).toUpperCase()+r.slice(1):""}h.layout=r=>e.jsx(b,{children:r,title:r.props.project.title});export{h as default};
