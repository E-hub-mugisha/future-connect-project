import{j as e,H as d,L as t}from"./app-DAdnLqM_.js";import{G as h}from"./GuestLayout-DypAKmPK.js";const m={"user.talents":"/skills-marketplace"},i=(a,n)=>(a["user.talents.category"]||"/skills/category/:slug").replace(":slug",n);function g({categories:a=[],routes:n={},assetBase:o=""}){const l=r=>n[r]||m[r]||"#",s=r=>`${o}${r}`,c=a.slice(0,6);return e.jsxs(e.Fragment,{children:[e.jsx(d,{title:"Networking Hub – Connect with Skills & Opportunities"}),e.jsx("link",{rel:"preconnect",href:"https://fonts.googleapis.com"}),e.jsx("link",{href:"https://fonts.googleapis.com/css2?family=Syne:wght@700;800;900&display=swap",rel:"stylesheet"}),e.jsx("style",{children:`
        /* ── Tokens ──────────────────────────────────────────────── */
        :root {
            --bg-base: #0e1618;
            --bg-card: #131e21;
