import{r as d,j as e,H as m,L as i,a as b}from"./app-CZoN4D26.js";import{A as p}from"./AppLayout-cgNkyb5j.js";function N({courses:s}){const[a,r]=d.useState(""),[n,l]=d.useState(null),o=s.filter(t=>t.title.toLowerCase().includes(a.toLowerCase()));function h(){b.delete(route("talent.courses.destroy",n.id),{preserveScroll:!0,onSuccess:()=>l(null)})}return e.jsxs(p,{children:[e.jsx(m,{title:"Courses"}),e.jsxs("div",{"data-h-scope":"talent-courses",children:[e.jsx("style",{children:`
