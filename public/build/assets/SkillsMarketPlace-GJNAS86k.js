import{r as i,u as g,j as e,H as m,L as a,a as x}from"./app-BV2sDVKx.js";import{G as f}from"./GuestLayout-zw3aPGz3.js";function b({categories:o=[]}){const[d,c]=i.useState(null),[v,y]=i.useState(0),[j,s]=i.useState(!1),[w,k]=i.useState(!1),[n,l]=i.useState({keyword:"",category:""}),{data:N,setData:S,post:z,processing:q,errors:C,reset:F}=g({name:"",address:"",phone:"",email:"",language:"",category_id:"",description:"",image:null});function p(r){c(t=>t===r?null:r)}function h(r){r.preventDefault(),x.get(route("talent.search"),n),s(!1)}return e.jsxs(e.Fragment,{children:[e.jsx(m,{title:"Skilled Marketplace – Get Discovered. Get Hired. Get Growing."}),e.jsx("link",{rel:"stylesheet",href:"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css"}),e.jsx("style",{children:`
        :root {
          --bg:        #0e1618;
          --bg2:       #131d20;
          --bg3:       #18242a;
