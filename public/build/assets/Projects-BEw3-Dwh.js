import{r as h,j as e,H as g,L as t,a as d}from"./app-BO26Fp_i.js";import{G as p}from"./GuestLayout-RkVoz6LJ.js";function m({categories:c=[],projects:o=[]}){const[i,n]=h.useState({category:"",location:"",keyword:""});function f(a){a.preventDefault();const r=Object.fromEntries(Object.entries(i).filter(([,s])=>s!==""));d.get(route("user.projects.all"),r)}function l(a){d.get(route("user.projects.all"),{keyword:a})}return e.jsxs(e.Fragment,{children:[e.jsx(g,{title:"Projects Collaborations"}),e.jsx("style",{children:`
        :root {
          --fc-bg: #0e1618;
          --fc-bg-alt: #141d20;
          --fc-card: #172124;
