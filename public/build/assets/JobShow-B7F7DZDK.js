import{r as d,_ as L,u as T,j as e,H as F,L as h}from"./app-DAdnLqM_.js";import{G as P}from"./GuestLayout-DypAKmPK.js";const $={"user.jobs.index":"/jobs","user.jobs.show":"/jobs/:id","user.jobs.apply":"/jobs",pricing:"/pricing"},p=50,I=5*1024*1024,U=["application/pdf","application/msword","application/vnd.openxmlformats-officedocument.wordprocessingml.document"],O=/\.(pdf|doc|docx)$/i;function H({job:s,categories:N=[],recent:w=[],filters:b={},routes:k={},assetBase:S="",showSubscribeModal:z=!1}){var v,y;const l=r=>k[r]||$[r]||"#",o=r=>`${S}${r}`,E=s.apply_url||`${l("user.jobs.apply")}/${s.id}`,M=r=>r.show_url||`${l("user.jobs.show")}/${r.id}`,m=d.useRef(null),n=d.useRef(null),x=d.useRef(null),c=d.useRef(null);d.useEffect(()=>{let r=!1;return L(async()=>{const{Modal:a}=await import("./bootstrap.esm-ifhUiil8.js");return{Modal:a}},[]).then(({Modal:a})=>{r||(m.current&&(n.current=new a(m.current)),x.current&&(c.current=new a(x.current),z&&c.current.show()))}),()=>{var a,_;r=!0,(a=n.current)==null||a.dispose(),(_=c.current)==null||_.dispose()}},[]);const D=()=>{var r;return(r=n.current)==null?void 0:r.show()},j=()=>{var r;return(r=n.current)==null?void 0:r.hide()},u=()=>{var r;return(r=c.current)==null?void 0:r.hide()},t=T({cover_letter:"",resume:null}),[i,f]=d.useState({cover_letter:"",resume:""}),g=t.data.cover_letter.trim().length,R=g>=p?"#48d597":"#f07070",A=()=>{const r={cover_letter:"",resume:""};g<p&&(r.cover_letter=`Please write at least ${p} characters.`);const a=t.data.resume;return a?!O.test(a.name)&&!U.includes(a.type)?r.resume="Only PDF, DOC, or DOCX files are accepted.":a.size>I&&(r.resume="File size must not exceed 5 MB."):r.resume="Please upload your resume.",f(r),!r.cover_letter&&!r.resume},C=r=>{if(r.preventDefault(),!A()){const a=document.querySelector("#jobApplyModalPage .is-invalid");a&&a.scrollIntoView({behavior:"smooth",block:"center"});return}t.post(E,{forceFormData:!0,onSuccess:()=>{t.reset(),f({cover_letter:"",resume:""}),j()}})};return s?e.jsxs(e.Fragment,{children:[e.jsx(F,{title:s.title}),e.jsx("style",{children:`
        /* ── Tokens ─────────────────────────────────────── */
        :root {
            --bg: #0e1618;
            --surface: #131e21;
