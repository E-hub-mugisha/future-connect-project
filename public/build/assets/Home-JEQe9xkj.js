import{r as h,j as e,H as b,L as s}from"./app-CzHhKsxF.js";import{G as j}from"./GuestLayout-XZ7pV8zu.js";function i(r,o){try{return route(r,o)}catch{return console.warn(`route("${r}") failed — Ziggy config not found. Make sure @routes is included in resources/views/app.blade.php (in <head>, before the Inertia app div).`),"#"}}function p(r,o=1){if(r!=null&&r.image)return r.image.startsWith("http")?r.image:`/image/talents/${r.image}`;const l=(o-1)%90+1;return`https://randomuser.me/api/portraits/${o%2===0?"women":"men"}/${l}.jpg`}function N(r){return r!=null&&r.logo?r.logo.startsWith("http")?r.logo:`/image/partners/${r.logo}`:r!=null&&r.domain?`https://www.google.com/s2/favicons?sz=128&domain=${r.domain}`:"https://www.google.com/s2/favicons?sz=128&domain=example.com"}const n={heroA:"https://images.unsplash.com/photo-1758518731706-be5d5230e5a5?auto=format&fit=crop&w=1600&q=80",heroB:"https://images.unsplash.com/photo-1758518730384-be3d205838e8?auto=format&fit=crop&w=1600&q=80",skills:"https://images.unsplash.com/photo-1758873268745-dd2cf0d677b5?auto=format&fit=crop&w=900&q=80",learning:"https://images.unsplash.com/photo-1752650735119-8929e5f7d1ec?auto=format&fit=crop&w=900&q=80",jobs:"https://images.unsplash.com/photo-1758518730384-be3d205838e8?auto=format&fit=crop&w=900&q=80",connect1:"https://images.unsplash.com/photo-1758691737083-0e7fdbde0f05?auto=format&fit=crop&w=700&q=80",connect2:"https://images.unsplash.com/photo-1758518731706-be5d5230e5a5?auto=format&fit=crop&w=700&q=80"},w=[{name:"MTN Rwanda",logo:"https://commons.wikimedia.org/wiki/Special:FilePath/MTN_2022_logo.svg"},{name:"RwandAir",logo:"https://commons.wikimedia.org/wiki/Special:FilePath/RwandAir_Logotype.png?width=300"},{name:"Airtel Rwanda",logo:"https://commons.wikimedia.org/wiki/Special:FilePath/Airtel_Africa_logo.svg"},{name:"Equity Bank Rwanda",logo:"https://commons.wikimedia.org/wiki/Special:FilePath/Equity_Group_Logo.png?width=300"}];function v({rating:r=0}){return e.jsx(e.Fragment,{children:Array.from({length:5}).map((o,l)=>e.jsx("span",{children:l<r?"★":"☆"},l))})}function y({totalTalents:r=0,partners:o=[],categories:l=[],featuredTalents:u=[],testimonials:m=[]}){const x=h.useRef(null),g=h.useRef(null),f=o.length>0?o:w;return h.useEffect(()=>{window.bootstrap&&x.current&&new window.bootstrap.Carousel(x.current,{interval:6e3,pause:!1})},[]),h.useEffect(()=>{window.bootstrap&&g.current&&new window.bootstrap.Carousel(g.current,{interval:6e3})},[m.length]),e.jsxs(e.Fragment,{children:[e.jsx(b,{title:"Future Connect — Get Discovered. Get Hired."}),e.jsx("style",{children:`
        :root {
          --bg: #0e1618;
          --bg-card: #131e21;
      ...
      `}),e.jsxs("section",{className:"fc-hero",children:[e.jsx("div",{className:"fc-hero-bg",children:e.jsx("div",{id:"heroBgCarousel",className:"carousel slide",ref:x,children:e.jsxs("div",{className:"carousel-inner",children:[e.jsx("div",{className:"carousel-item active",children:e.jsx("div",{className:"fc-hero-bg-slide",style:{backgroundImage:`url('${n.heroA}')`}})}),e.jsx("div",{className:"carousel-item",children:e.jsx("div",{className:"fc-hero-bg-slide",style:{backgroundImage:`url('${n.heroB}')`}})})]})})}),e.jsx("div",{className:"fc-hero-overlay"}),e.jsx("div",{className:"container fc-hero-content",children:e.jsx("div",{className:"row align-items-center",children:e.jsxs("div",{className:"col-lg-7",children:[e.jsxs("p",{className:"hero-eyebrow",children:[r,"+ verified professionals, already hired"]}),e.jsxs("h1",{children:["Stop getting overlooked. ",e.jsx("span",{className:"hl",children:"Start getting hired."})]}),e.jsx("p",{children:"Put your verified skills in front of people actively hiring — no cold applications, no algorithm burying your profile."}),e.jsxs("div",{className:"hero-ctas",children:[e.jsxs(s,{href:i("user.register_skills"),className:"btn-fc-primary",children:["Claim Your Free Profile ",e.jsx("i",{className:"ti ti-arrow-right"})]}),e.jsxs(s,{href:i("user.talents"),className:"btn-fc-outline",children:["See Who's Hiring ",e.jsx("i",{className:"ti ti-arrow-right"})]})]}),e.jsxs("div",{className:"hero-stats",children:[e.jsxs("div",{children:[e.jsxs("div",{className:"hero-stat-val",children:[r,"+"]}),e.jsx("div",{className:"hero-stat-lbl",children:"Verified Professionals"})]}),e.jsxs("div",{children:[e.jsxs("div",{className:"hero-stat-val",children:[f.length,"+"]}),e.jsx("div",{className:"hero-stat-lbl",children:"Trusted Partners"})]}),e.jsxs("div",{children:[e.jsx("div",{className:"hero-stat-val",children:"4.8"}),e.jsx("div",{className:"hero-stat-lbl",children:"Average Rating"})]})]})]})})})]}),e.jsx("div",{className:"fc-feature-strip",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"feature-strip-grid",children:[e.jsxs("div",{className:"feature-strip-item",children:[e.jsx("div",{className:"strip-icon",children:e.jsx("i",{className:"ti ti-rocket"})}),e.jsx("h5",{children:"Get Seen Faster"}),e.jsx("p",{children:"Verified, boosted profiles jump the queue and get featured on our homepage."}),e.jsxs(s,{href:i("user.talents"),className:"strip-link",children:["Find Skills ",e.jsx("i",{className:"ti ti-arrow-right"})]})]}),e.jsxs("div",{className:"feature-strip-item",children:[e.jsx("div",{className:"strip-icon",children:e.jsx("i",{className:"ti ti-briefcase"})}),e.jsx("h5",{children:"Never Miss the Right Job"}),e.jsx("p",{children:"Gigs and roles matched to your actual skills, not keyword spam."}),e.jsxs(s,{href:i("user.jobs.index"),className:"strip-link",children:["Start Exploring ",e.jsx("i",{className:"ti ti-arrow-right"})]})]}),e.jsxs("div",{className:"feature-strip-item",children:[e.jsx("div",{className:"strip-icon",children:e.jsx("i",{className:"ti ti-users"})}),e.jsx("h5",{children:"Build a Network That Works"}),e.jsx("p",{children:"Meet the people and collaborators who move a career forward."}),e.jsxs(s,{href:i("talent.connections-room"),className:"strip-link",children:["Skill Connect ",e.jsx("i",{className:"ti ti-arrow-right"})]})]})]})})}),e.jsx("section",{className:"fc-feature-section",id:"skills",children:e.jsx("div",{className:"container",children:e.jsx("div",{className:"feature-panel-card",children:e.jsxs("div",{className:"row align-items-center g-5",children:[e.jsxs("div",{className:"col-lg-6",children:[e.jsxs("span",{className:"fc-badge mb-3",children:[e.jsx("i",{className:"ti ti-sparkles"})," Skills Marketplace"]}),e.jsxs("h2",{children:["Turn your skills ",e.jsx("span",{children:"into your next client."})]}),e.jsx("p",{children:"Get verified, showcase your best work, and turn profile views into paying opportunities."}),e.jsxs("ul",{className:"feature-list",children:[e.jsx("li",{children:"Get verified and build instant credibility"}),e.jsx("li",{children:"Feature your work on our homepage"})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:20,flexWrap:"wrap"},children:[e.jsxs(s,{href:i("user.talents"),className:"btn-fc-primary",children:["Get Discovered ",e.jsx("i",{className:"ti ti-arrow-right"})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:12},children:[e.jsx("div",{className:"avatar-stack",children:u.map((a,t)=>e.jsx("img",{src:p(a,t+1),alt:""},a.id??t))}),e.jsxs("div",{children:[e.jsx("div",{style:{color:"var(--accent)",fontSize:"0.8rem"},children:"★★★★★ 4.8/5"}),e.jsxs("div",{style:{fontSize:"0.72rem",color:"var(--text-3)"},children:[r,"+ already in"]})]})]})]})]}),e.jsx("div",{className:"col-lg-6 feature-img-wrap",children:e.jsx("img",{src:n.skills,alt:"Professional showcasing a portfolio"})})]})})})}),e.jsx("section",{className:"fc-feature-section alt",id:"learning",children:e.jsx("div",{className:"container",children:e.jsx("div",{className:"feature-panel-card",children:e.jsxs("div",{className:"row align-items-center g-5",children:[e.jsxs("div",{className:"col-lg-6",children:[e.jsxs("span",{className:"fc-badge mb-3",children:[e.jsx("i",{className:"ti ti-school"})," Learning Center"]}),e.jsxs("h2",{children:["The skills gap ends ",e.jsx("span",{children:"here."})]}),e.jsx("p",{children:"Short, sharp micro-courses taught by people doing the work right now."}),e.jsxs("ul",{className:"feature-list",children:[e.jsx("li",{children:"Finish a course in a week, not a semester"}),e.jsx("li",{children:"Shareable certificates for your profile"})]}),e.jsxs(s,{href:i("user.courses"),className:"btn-fc-primary",children:["Start Learning Free ",e.jsx("i",{className:"ti ti-arrow-right"})]})]}),e.jsx("div",{className:"col-lg-6 feature-img-wrap",children:e.jsx("img",{src:n.learning,alt:"Person learning online"})})]})})})}),e.jsx("section",{className:"fc-feature-section",id:"opportunities",children:e.jsx("div",{className:"container",children:e.jsx("div",{className:"feature-panel-card",children:e.jsxs("div",{className:"row align-items-center g-5",children:[e.jsxs("div",{className:"col-lg-6",children:[e.jsxs("span",{className:"fc-badge mb-3",children:[e.jsx("i",{className:"ti ti-briefcase"})," Opportunities"]}),e.jsxs("h2",{children:["Real roles. ",e.jsx("span",{children:"Zero noise."})]}),e.jsx("p",{children:"Skip the open job boards. Get matched with verified people and real work."}),e.jsxs("ul",{className:"feature-list",children:[e.jsx("li",{children:"Post roles in minutes"}),e.jsx("li",{children:"Set alerts so the right match finds you"})]}),e.jsxs(s,{href:i("user.jobs.index"),className:"btn-fc-primary",children:["Browse Open Roles ",e.jsx("i",{className:"ti ti-arrow-right"})]})]}),e.jsx("div",{className:"col-lg-6 feature-img-wrap",children:e.jsx("img",{src:n.jobs,alt:"Person reviewing job opportunities"})})]})})})}),e.jsx("section",{className:"fc-feature-section alt",id:"connect",children:e.jsx("div",{className:"container",children:e.jsx("div",{className:"feature-panel-card",children:e.jsxs("div",{className:"row align-items-center g-5",children:[e.jsx("div",{className:"col-lg-5",children:e.jsxs("div",{className:"row g-3",children:[e.jsx("div",{className:"col-6",children:e.jsx("img",{src:n.connect1,alt:"Two professionals collaborating at a laptop",className:"img-fluid",style:{borderRadius:"var(--r-md)",width:"100%",height:"260px",objectFit:"cover"}})}),e.jsx("div",{className:"col-6",children:e.jsx("img",{src:n.connect2,alt:"Colleagues talking together",className:"img-fluid",style:{borderRadius:"var(--r-md)",width:"100%",height:"260px",objectFit:"cover"}})})]})}),e.jsxs("div",{className:"col-lg-7",children:[e.jsxs("span",{className:"fc-badge mb-3",children:[e.jsx("i",{className:"ti ti-users"})," Connection Room"]}),e.jsxs("h2",{children:["Your next break ",e.jsx("span",{children:"starts with one message."})]}),e.jsx("p",{children:"A private space for verified professionals to message, meet, and collaborate."}),e.jsxs("ul",{className:"feature-list",children:[e.jsx("li",{children:"A diverse, verified professional network"}),e.jsx("li",{children:"A simple, distraction-free way to connect"})]}),e.jsxs(s,{href:i("talent.connections-room"),className:"btn-fc-primary",children:["Join the Room ",e.jsx("i",{className:"ti ti-arrow-right"})]})]})]})})})}),e.jsx("section",{className:"fc-feature-section",id:"marketplace",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"feature-panel-card",children:[e.jsxs("span",{className:"fc-badge mb-3",children:[e.jsx("i",{className:"ti ti-shopping-bag"})," Marketplace"]}),e.jsxs("h2",{children:["Turn what you make ",e.jsx("span",{children:"into what you earn."})]}),e.jsx("p",{children:"Sell your digital work with full payment protection, or shop with total confidence."}),e.jsxs("div",{className:"fc-provide-grid",children:[e.jsxs("div",{className:"fc-provide-box",children:[e.jsx("div",{className:"provide-icon",children:e.jsx("i",{className:"ti ti-shopping-cart"})}),e.jsx("h6",{children:"Browse Products"}),e.jsx("p",{children:"Secure payments through Future Connect."}),e.jsxs(s,{href:i("user.products.index"),className:"btn-fc-primary",style:{fontSize:"0.8rem",padding:"9px 18px"},children:["Explore ",e.jsx("i",{className:"ti ti-arrow-right"})]})]}),e.jsxs("div",{className:"fc-provide-box",children:[e.jsx("div",{className:"provide-icon",children:e.jsx("i",{className:"ti ti-package"})}),e.jsx("h6",{children:"Sell a Product"}),e.jsx("p",{children:"Reach buyers already on the platform."}),e.jsxs("a",{"data-bs-toggle":"modal","data-bs-target":"#applySellerModal",className:"btn-fc-outline",style:{fontSize:"0.8rem",padding:"9px 18px",cursor:"pointer"},children:["Learn More ",e.jsx("i",{className:"ti ti-arrow-right"})]})]}),e.jsxs("div",{className:"fc-provide-box",children:[e.jsx("div",{className:"provide-icon",children:e.jsx("i",{className:"ti ti-user-check"})}),e.jsx("h6",{children:"Become a Seller"}),e.jsx("p",{children:"Get paid instantly, minus a small platform fee."}),e.jsxs("a",{className:"btn-fc-primary","data-bs-toggle":"modal","data-bs-target":"#applySellerModal",style:{fontSize:"0.8rem",padding:"9px 18px",cursor:"pointer"},children:["Apply Now ",e.jsx("i",{className:"ti ti-arrow-right"})]})]})]})]})})}),e.jsx("section",{className:"fc-how",children:e.jsxs("div",{className:"container",children:[e.jsxs("div",{className:"fc-section-head text-center",style:{maxWidth:560,margin:"0 auto 40px"},children:[e.jsx("span",{className:"eyebrow",children:"How It Works"}),e.jsx("h2",{children:"From sign-up to standout — in 3 steps"})]}),e.jsxs("div",{className:"steps-grid",children:[e.jsxs("div",{className:"step-card",children:[e.jsx("span",{className:"step-num",children:"01"}),e.jsx("h5",{children:"Create Your Profile"}),e.jsx("p",{children:"Sign up free and showcase your skills in minutes."}),e.jsxs(s,{href:i("user.register_skills"),className:"strip-link",children:["Get Started ",e.jsx("i",{className:"ti ti-arrow-right"})]})]}),e.jsxs("div",{className:"step-card",children:[e.jsx("span",{className:"step-num",children:"02"}),e.jsx("h5",{children:"Get Discovered & Rated"}),e.jsx("p",{children:"Employers browse, rate, and build your reputation."}),e.jsxs(s,{href:i("user.talents"),className:"strip-link",children:["Explore Skills ",e.jsx("i",{className:"ti ti-arrow-right"})]})]}),e.jsxs("div",{className:"step-card",children:[e.jsx("span",{className:"step-num",children:"03"}),e.jsx("h5",{children:"Grow With the Community"}),e.jsx("p",{children:"Connect with peers and keep learning as you go."}),e.jsxs(s,{href:i("talent.connections-room"),className:"strip-link",children:["Connection Room ",e.jsx("i",{className:"ti ti-arrow-right"})]})]})]})]})}),e.jsx("section",{className:"fc-partners",children:e.jsxs("div",{className:"container",children:[e.jsxs("div",{className:"fc-section-head text-center",style:{margin:"0 auto 8px"},children:[e.jsx("span",{className:"eyebrow",children:"Our Partners"}),e.jsx("h2",{children:"Building a global network"})]}),e.jsxs("p",{className:"partners-label",children:["Trusted by ",f.length,"+ partners worldwide"]}),e.jsx("div",{className:"partners-grid",children:f.map((a,t)=>e.jsx("div",{className:"partner-tile",children:e.jsx("img",{src:N(a),alt:a.name??"Partner"})},a.id??a.domain??t))})]})}),e.jsx("section",{className:"fc-testimonials",children:e.jsxs("div",{className:"container",children:[e.jsxs("div",{className:"row align-items-end mb-5",children:[e.jsx("div",{className:"col-md-7",children:e.jsxs("div",{className:"fc-section-head",style:{marginBottom:0},children:[e.jsx("span",{className:"eyebrow",children:"Testimonials"}),e.jsx("h2",{children:"Real stories from real talent"}),e.jsx("p",{children:"Professionals who've grown their careers through Future Connect."})]})}),e.jsxs("div",{className:"col-md-5 text-md-end",children:[e.jsx("div",{className:"avatar-stack",style:{justifyContent:"flex-end",marginBottom:8},children:m.map((a,t)=>e.jsx("img",{src:p(a.talent,t+1),alt:""},a.id??t))}),e.jsx("p",{style:{fontSize:"0.75rem",color:"var(--text-3)"},children:"Building a global talent community"})]})]}),e.jsx("div",{className:"testimonial-grid d-none d-md-grid",children:m.map((a,t)=>{var c,d;return e.jsxs("div",{className:"testimonial-card",children:[e.jsxs("div",{className:"testimonial-head",children:[e.jsx("img",{src:p(a.talent,t+1),alt:""}),e.jsxs("div",{children:[e.jsx("div",{className:"testimonial-name",children:((c=a.talent)==null?void 0:c.name)??"Talent"}),e.jsx("div",{className:"testimonial-role",children:a.title??"Creative Professional"})]}),e.jsx("div",{className:"testimonial-stars",children:e.jsx(v,{rating:a.rating})})]}),e.jsx("div",{className:"testimonial-body",children:e.jsx("p",{children:a.content??"Future Connect helped me turn my skills into steady, real opportunities."})}),e.jsxs("div",{className:"testimonial-loc",children:[e.jsx("i",{className:"ti ti-map-pin",style:{color:"var(--accent)"}}),((d=a.talent)==null?void 0:d.address)??"Kigali, Rwanda"]})]},a.id??t)})}),e.jsx("div",{id:"testimonialCarousel",className:"carousel slide d-md-none",ref:g,children:e.jsx("div",{className:"carousel-inner",children:m.map((a,t)=>{var c,d;return e.jsx("div",{className:`carousel-item${t===0?" active":""}`,children:e.jsxs("div",{className:"testimonial-card",style:{margin:"0 auto",maxWidth:380},children:[e.jsxs("div",{className:"testimonial-head",children:[e.jsx("img",{src:p(a.talent,t+1),alt:""}),e.jsxs("div",{children:[e.jsx("div",{className:"testimonial-name",children:((c=a.talent)==null?void 0:c.name)??"Talent"}),e.jsx("div",{className:"testimonial-role",children:a.title??"Creative Professional"})]}),e.jsx("div",{className:"testimonial-stars",children:e.jsx(v,{rating:a.rating})})]}),e.jsx("div",{className:"testimonial-body",children:e.jsx("p",{children:a.content??"Future Connect helped me turn my skills into steady, real opportunities."})}),e.jsxs("div",{className:"testimonial-loc",children:[e.jsx("i",{className:"ti ti-map-pin",style:{color:"var(--accent)"}}),((d=a.talent)==null?void 0:d.address)??"Kigali, Rwanda"]})]})},a.id??t)})})})]})}),e.jsx("div",{className:"container",children:e.jsxs("div",{className:"fc-cta",children:[e.jsx("div",{className:"fc-cta-glow"}),e.jsx("div",{className:"row align-items-center",children:e.jsxs("div",{className:"col-md-7",style:{position:"relative"},children:[e.jsx("span",{className:"eyebrow",style:{fontSize:"0.72rem",textTransform:"uppercase",letterSpacing:"0.1em",color:"var(--accent)",fontWeight:600,display:"block",marginBottom:10},children:"Join Future Connect"}),e.jsx("h2",{children:"Your skills deserve to be seen."}),e.jsx("p",{children:"Join a growing community of verified professionals building real careers."}),e.jsxs("div",{className:"hero-ctas",style:{marginBottom:6},children:[e.jsxs(s,{href:i("user.register_skills"),className:"btn-fc-primary",children:["Get Started Free ",e.jsx("i",{className:"ti ti-arrow-right"})]}),e.jsx(s,{href:i("user.talents"),className:"btn-fc-outline",children:"Browse Skills"})]}),e.jsx("p",{className:"fc-cta-note",children:"No credit card. No commitment."})]})})]})})]})}y.layout=r=>e.jsx(j,{children:r});export{y as default};
