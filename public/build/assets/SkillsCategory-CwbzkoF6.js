import{r as d,j as e,H as E,L as o,d as T}from"./app-DAdnLqM_.js";import{G as A}from"./GuestLayout-DypAKmPK.js";const i={talentsCategory:t=>`/skills/category/${t}`,talentDetails:t=>`/skills/${t}`,skills:"/skills-marketplace"};function R({categoryName:t,categories:c=[],talents:p=[],filters:m={}}){const[g,k]=d.useState("all"),[b,x]=d.useState(""),[w,h]=d.useState(null),[v,S]=d.useState(m.keyword||""),[f,C]=d.useState(m.category||""),u=a=>!a.feedback||a.feedback.length===0?"0.0":(a.feedback.reduce((s,l)=>s+(l.rating||0),0)/a.feedback.length).toFixed(1),n=d.useMemo(()=>p.filter(a=>{var j,y,N;const r=g==="all"||(a.tag||"featured").toLowerCase()===g,s=b.toLowerCase(),l=!s||((j=a.name)==null?void 0:j.toLowerCase().includes(s))||((N=(y=a.category)==null?void 0:y.name)==null?void 0:N.toLowerCase().includes(s));return r&&l}),[p,g,b]),z=a=>{a.preventDefault(),T.get(i.talents,{keyword:v,category:f},{preserveState:!0})},F=[{key:"all",label:"All"},{key:"latest",label:"Latest"},{key:"popular",label:"Popular"},{key:"featured",label:"Featured"},{key:"recommended",label:"Recommended"}];return e.jsxs(e.Fragment,{children:[e.jsx(E,{title:`${t} Talents`}),e.jsx("link",{href:"https://fonts.googleapis.com/css2?family=Syne:wght@400;600;700;800&family=DM+Sans:wght@300;400;500&display=swap",rel:"stylesheet"}),e.jsx("style",{children:`
                :root {
                    --bg:         #0e1618;
                    --bg2:        #131d20;
                    --bg3:        #18242a;
