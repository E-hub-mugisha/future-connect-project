import{d as C,r as m,u as D,j as s,H as M,L as p,a as y}from"./app-BV2sDVKx.js";import{G as E}from"./GuestLayout-zw3aPGz3.js";function R(r){return r?r.replace(/<[^>]*>/g,""):""}function I(r,t=100){return r?r.length>t?r.slice(0,t).trimEnd()+"...":r:""}function N({id:r,title:t,onClose:o,children:l,footer:d}){return s.jsxs("div",{className:"modal fade ss-modal show",id:r,style:{display:"block"},tabIndex:"-1",role:"dialog","aria-modal":"true",children:[s.jsx("div",{className:"modal-backdrop fade show",onClick:o,style:{zIndex:1040}}),s.jsx("div",{className:"modal-dialog modal-dialog-centered modal-lg",style:{zIndex:1050,position:"relative"},children:s.jsxs("div",{className:"modal-content",children:[s.jsxs("div",{className:"modal-header",children:[s.jsx("h5",{className:"modal-title",children:t}),s.jsx("button",{type:"button",className:"btn-close","aria-label":"Close",onClick:o})]}),s.jsx("div",{className:"modal-body",children:l}),d&&s.jsx("div",{className:"modal-footer",children:d})]})})]})}function A({stories:r,search:t="",role:o="",roles:l=[]}){var j;const{props:d}=C(),b=(j=d.flash)==null?void 0:j.story_submitted,u=(r==null?void 0:r.data)??[],h=(r==null?void 0:r.links)??[],w=Array.isArray(r==null?void 0:r.links),g=(r==null?void 0:r.total)??u.length,[f,k]=m.useState(t),[S,i]=m.useState(!1),[n,x]=m.useState(null),a=D({title:"",author_name:"",role:"",excerpt:"",content:"",thumbnail:null});function z(e){e.preventDefault(),a.post(route("user.success-stories.store"),{forceFormData:!0,onSuccess:()=>{i(!1),a.reset()},onError:()=>{i(!0)}})}function _(e){e.preventDefault(),y.get(route("user.success-stories"),{search:f||void 0,role:o||void 0})}function v(e){return route("user.success-stories",e)}const F=!!(o||t);return s.jsxs(s.Fragment,{children:[s.jsx(M,{title:"Success Stories | Future Connect"}),s.jsx("style",{children:`
        :root {
          --ss-bg: #0e1618;
          --ss-surface: #141d20;
          --ss-surface2: #1a2428;
