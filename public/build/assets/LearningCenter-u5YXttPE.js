import{j as e,H as b,L as a}from"./app-CzHhKsxF.js";import{G as f}from"./GuestLayout-XZ7pV8zu.js";const v=[{id:"story-1",name:"Aline U.",role:"Graphic Designer → UI/UX Instructor",avatar:"/assets/img/user/profile.jpg",quote:"I listed my design skills, then took two courses on the platform to sharpen my UI/UX process. Six months later I was teaching my own course to 400+ learners.",stat:"400+ students taught"},{id:"story-2",name:"Eric N.",role:"Self-taught Developer",avatar:"/assets/img/user/profile.jpg",quote:"I had no formal training — just a laptop and curiosity. The free coding courses here got me from zero to my first freelance contract in four months.",stat:"First client in 4 months"},{id:"story-3",name:"Grace M.",role:"Tailor & Business Coach",avatar:"/assets/img/user/profile.jpg",quote:"My tailoring business was stuck at the same five clients for years. The business-skills courses taught me pricing and pitching — now I run a small team.",stat:"Grew from solo to a team of 4"}];function j({popularCourses:s=[],categories:o=[],stats:n={},stories:c=v}){const d=n.totalCourses??0,p=n.totalLearners??"74K",h=n.totalCategories??o.length;function l(r){var i;return r.courses_count??((i=r.courses)==null?void 0:i.length)??0}function x(r){return r.feedback_avg_rating!=null?Number(r.feedback_avg_rating):r.avg_rating!=null?Number(r.avg_rating):Array.isArray(r.feedback)&&r.feedback.length?r.feedback.reduce((i,t)=>i+t.rating,0)/r.feedback.length:0}function g(r){return r.feedback_count!=null?r.feedback_count:r.reviews_count!=null?r.reviews_count:Array.isArray(r.feedback)?r.feedback.length:0}function m(r){return r.enrollments_count!=null?r.enrollments_count:Array.isArray(r.enrollments)?r.enrollments.length:0}function u(r){return r>=1e3?`${(r/1e3).toFixed(r%1e3===0?0:1)}k`:`${r}`}return e.jsxs(e.Fragment,{children:[e.jsx(b,{title:"Learning Center and Courses"}),e.jsx("link",{href:"https://fonts.googleapis.com/css2?family=Syne:wght@400;600;700;800&family=DM+Sans:wght@300;400;500&display=swap",rel:"stylesheet"}),e.jsx("style",{children:`
        :root {
          --bg:         #0e1618;
          --bg2:        #131d20;
          --bg3:        #18242a;
