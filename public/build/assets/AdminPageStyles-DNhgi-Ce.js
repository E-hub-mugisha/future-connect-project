import{j as p}from"./app-DQcVR1sC.js";const d=`
...
`;function s({name:a,children:e,className:r="",fluid:t=!0,...o}){return p.jsxs(p.Fragment,{children:[p.jsx("style",{children:d}),p.jsx("div",{"data-ap-scope":a,className:`${t?"container-fluid":"container"} ${r}`,...o,children:e})]})}function c({paginator:a}){return!(a!=null&&a.links)||a.links.length<=3?null:p.jsx("div",{className:"ap-pagination",children:a.links.map((e,r)=>e.url?p.jsx("a",{href:e.url,className:`ap-btn ap-btn-sm ${e.active?"ap-btn-primary":"ap-btn-ghost"}`,dangerouslySetInnerHTML:{__html:e.label}},r):p.jsx("span",{className:"ap-btn ap-btn-sm ap-btn-ghost",style:{opacity:.5,cursor:"default"},dangerouslySetInnerHTML:{__html:e.label}},r))})}export{s as A,c as P};
