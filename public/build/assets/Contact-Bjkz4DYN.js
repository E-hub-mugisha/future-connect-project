import{a as c,u as l,j as e,H as d}from"./app-DAdnLqM_.js";import{G as p}from"./GuestLayout-DypAKmPK.js";function x(){var t;const{props:i}=c(),s=(t=i.flash)==null?void 0:t.success,r=l({names:"",email:"",subject:"",message:""});function o(a){a.preventDefault(),r.post(route("contact.send"),{preserveScroll:!0,onSuccess:()=>r.reset()})}const n=Object.keys(r.errors).length>0;return e.jsxs(e.Fragment,{children:[e.jsx(d,{title:"Contact Us"}),e.jsx("style",{children:`
        /* ── Google Font ─────────────────────────────── */
