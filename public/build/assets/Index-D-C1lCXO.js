import{d as g,r as f,j as e,H as v,L as p,a as o}from"./app-BV2sDVKx.js";import{A as j}from"./AppLayout-KiVsabfS.js";const y=()=>e.jsx("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:e.jsx("path",{d:"M20 6 9 17l-5-5"})});function w({demoRequests:t,filters:s,statusCounts:h}){var l;const{flash:d}=g().props,[n,x]=f.useState(s.search??"");function i(r){o.get(route("admin.demo-requests.index"),{status:r,search:s.search},{preserveState:!0})}function u(r){r.preventDefault(),o.get(route("admin.demo-requests.index"),{status:s.status,search:n},{preserveState:!0})}function b(r){o.patch(route("admin.demo-requests.confirm",r.id),{},{preserveState:!0,preserveScroll:!0})}const c={pending:{bg:"rgba(245,158,11,.15)",color:"#f59e0b"},confirmed:{bg:"rgba(0,166,103,.15)",color:"#00a667"},completed:{bg:"rgba(59,130,246,.15)",color:"#3b82f6"},cancelled:{bg:"rgba(220,76,76,.12)",color:"#dc4c4c"}};return e.jsxs("div",{"data-h-scope":"demo-requests-index",children:[e.jsx(v,{title:"Demo Requests"}),e.jsx("style",{children:`
