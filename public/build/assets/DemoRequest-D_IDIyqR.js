import{a as j,r as p,u as y,j as e,H as w,L as c}from"./app-B7IJkTeC.js";function l(t,s){try{return route(t,s)}catch{return console.warn(`route("${t}") failed — Ziggy config not found. Make sure @routes is included in resources/views/app.blade.php (in <head>, before the Inertia app div).`),"#"}}const k={"1-10":"1 – 10 employees","11-50":"11 – 50 employees","51-200":"51 – 200 employees","200+":"200+ employees"},N={morning:"Morning",afternoon:"Afternoon",evening:"Evening",flexible:"I'm flexible"};function z(){const[t,s]=p.useState("dark");return p.useEffect(()=>{const n=localStorage.getItem("fc-theme"),h=window.matchMedia("(prefers-color-scheme: light)").matches;s(n||(h?"light":"dark"))},[]),p.useEffect(()=>{const n=document.documentElement;t==="light"?n.setAttribute("data-h-theme","light"):n.removeAttribute("data-h-theme"),localStorage.setItem("fc-theme",t)},[t]),[t,()=>s(n=>n==="light"?"dark":"light")]}function _(t){p.useEffect(()=>{function s(){t.current&&document.documentElement.style.setProperty("--dr-header-h",`${t.current.offsetHeight}px`)}return s(),window.addEventListener("resize",s,{passive:!0}),()=>window.removeEventListener("resize",s)},[t])}function E({companySizes:t=k,preferredTimes:s=N}){const{flash:d}=j().props,[,n]=z(),h=p.useRef(null);_(h);const{data:m,setData:f,post:u,processing:g,errors:r}=y({full_name:"",work_email:"",phone:"",role:"",company_name:"",company_size:"",preferred_date:"",preferred_time:"",message:""}),x=Object.keys(r).length,b=new Date().toISOString().slice(0,10),i=a=>({id:a,name:a,value:m[a],onChange:o=>f(a,o.target.value)}),v=a=>{a.preventDefault(),u(l("demo.store"))};return e.jsxs(e.Fragment,{children:[e.jsx(w,{title:"Request a Demo — Future Connect",children:e.jsx("link",{href:"https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,400&display=swap",rel:"stylesheet"})}),e.jsx("style",{children:`
        :root {
          --bg: #0e1618;
          --surface: #141d20;
          --surface2: #1a2428;
