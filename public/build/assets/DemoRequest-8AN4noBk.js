import{d as j,r as p,u as y,j as e,H as w,L as c}from"./app-DQcVR1sC.js";function l(s,a){try{return route(s,a)}catch{return console.warn(`route("${s}") failed — Ziggy config not found. Make sure @routes is included in resources/views/app.blade.php (in <head>, before the Inertia app div).`),"#"}}const k={"1-10":"1 – 10 employees","11-50":"11 – 50 employees","51-200":"51 – 200 employees","200+":"200+ employees"},N={morning:"Morning",afternoon:"Afternoon",evening:"Evening",flexible:"I'm flexible"};function z(){const[s,a]=p.useState("dark");return p.useEffect(()=>{const o=localStorage.getItem("fc-theme"),h=window.matchMedia("(prefers-color-scheme: light)").matches;a(o||(h?"light":"dark"))},[]),p.useEffect(()=>{const o=document.documentElement;s==="light"?o.setAttribute("data-h-theme","light"):o.removeAttribute("data-h-theme"),localStorage.setItem("fc-theme",s)},[s]),[s,()=>a(o=>o==="light"?"dark":"light")]}function _(s){p.useEffect(()=>{function a(){s.current&&document.documentElement.style.setProperty("--dr-header-h",`${s.current.offsetHeight}px`)}return a(),window.addEventListener("resize",a,{passive:!0}),()=>window.removeEventListener("resize",a)},[s])}function S({companySizes:s=k,preferredTimes:a=N}){const{flash:d}=j().props,[,o]=z(),h=p.useRef(null);_(h);const{data:m,setData:f,post:u,processing:g,errors:r}=y({full_name:"",work_email:"",phone:"",role:"",company_name:"",company_size:"",preferred_date:"",preferred_time:"",message:""}),x=Object.keys(r).length,b=new Date().toISOString().slice(0,10),i=t=>({id:t,name:t,value:m[t],onChange:n=>f(t,n.target.value)}),v=t=>{t.preventDefault(),u(l("demo.store"))};return e.jsxs(e.Fragment,{children:[e.jsx(w,{title:"Request a Demo — Future Connect",children:e.jsx("link",{href:"https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,400&display=swap",rel:"stylesheet"})}),e.jsx("style",{children:`
        :root {
          --bg: #0e1618;
          --surface: #141d20;
          --surface2: #1a2428;
