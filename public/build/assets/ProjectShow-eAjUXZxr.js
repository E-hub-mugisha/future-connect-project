import{u as c,j as e,H as m,L as b}from"./app-C-Atdk99.js";import{G as f}from"./GuestLayout-be1venag.js";function h({project:r,recent:t=[]}){var o;const l=c({message:"",amount:"",currency:"USD"}),s=c({message:"",portfolio_url:"",attachment:null,name:"",email:""});function i(a){a.preventDefault(),l.post(route("diaspora.sponsorship.store",r.id))}function d(a){a.preventDefault(),s.post(route("user.projects.apply",r.id),{forceFormData:!0})}return e.jsxs(e.Fragment,{children:[e.jsx(m,{title:r.title}),e.jsx("style",{children:`
        :root{
          --fc-bg:#0e1618;
          --fc-bg-alt:#141d20;
          --fc-card:#172124;
